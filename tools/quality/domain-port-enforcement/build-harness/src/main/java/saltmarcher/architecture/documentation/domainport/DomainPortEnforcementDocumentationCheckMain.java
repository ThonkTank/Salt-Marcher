...
public final class DomainPortEnforcementDocumentationCheckMain {

    private DomainPortEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainPortEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Domain port enforcement documentation checks passed.");
    }
}
