...
public final class DataModelTopologyCheckMain {

    private DataModelTopologyCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataModelTopologyRules().check(context, sink);
        ...
        System.out.println("Data model topology checks passed.");
    }
}
