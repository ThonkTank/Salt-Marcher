...
public final class DataModelDocumentationEnforcementCheckMain {

    private DataModelDocumentationEnforcementCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataModelEnforcementCoverageRules().check(context, sink);
        ...
        System.out.println("Data model enforcement documentation checks passed.");
    }
}
