...
public final class DataMapperSourceMechanicsRule extends AbstractJavaRule {
    ...
    public Object visit(ASTCompilationUnit node, Object data) {
        ...
        if (!sourceFacts.isUnderMainSourceRoots() || !isMapper(sourceFacts)) {
            return data;
        }
        ...
        for (String token : CONCRETE_SOURCE_TOKENS) {
            if (sanitizedSourceText.contains(token)) {
                asCtx(data).addViolationWithMessage(node,
                        "Data mapper/ code must not own concrete source mechanics such as '"
