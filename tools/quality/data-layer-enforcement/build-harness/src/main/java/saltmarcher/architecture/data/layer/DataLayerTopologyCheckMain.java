...
public final class DataLayerTopologyCheckMain {

    private DataLayerTopologyCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataLayerTopologyRules().check(context, sink);
        ...
        System.out.println("Data layer topology checks passed.");
    }
}
