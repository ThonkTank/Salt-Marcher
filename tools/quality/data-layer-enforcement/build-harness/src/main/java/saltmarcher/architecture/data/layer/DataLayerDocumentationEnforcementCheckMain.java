...
public final class DataLayerDocumentationEnforcementCheckMain {

    private DataLayerDocumentationEnforcementCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataLayerEnforcementCoverageRules().check(context, sink);
        ...
        System.out.println("Data layer enforcement documentation checks passed.");
    }
}
