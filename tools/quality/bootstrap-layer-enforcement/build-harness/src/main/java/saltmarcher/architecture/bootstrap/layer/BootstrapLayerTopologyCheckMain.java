...
public final class BootstrapLayerTopologyCheckMain {

    private BootstrapLayerTopologyCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new BootstrapLayerTopologyRules().check(context, sink);
        ...
        System.out.println("Bootstrap layer topology checks passed.");
    }
}
