...
@BugPattern(
        name = "DomainFactoryStatelessness",
        summary = "Named-module domain factories must be stateless.",
        severity = BugPattern.SeverityLevel.ERROR)
public final class DomainFactoryStatelessnessChecker extends BugChecker implements BugChecker.ClassTreeMatcher {
    ...
    public Description matchClass(ClassTree tree, VisitorState state) {
        ...
        return buildDescription(tree)
                .setMessage("Named-module domain factory role '" + typeElement.getQualifiedName()
                        + "' declares instance field(s): " + String.join(", ", instanceFields)
                        + ". Domain factories must be stateless.")
                .build();
    }
}
