...
public final class DomainFactoryEnforcementDocumentationCheckMain {

    private DomainFactoryEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainFactoryEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Domain factory enforcement documentation checks passed.");
    }
}
