...
public final class ViewContentModelTopologyCheckMain {

    private ViewContentModelTopologyCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new ViewContentModelTopologyRules().check(context, sink);
        ...
        if (!ordered.isEmpty()) {
            ...
            System.err.println("ViewContentModel topology check failed with " + ordered.size()
                    + " violation(s):" + System.lineSeparator() + body);
            System.exit(1);
        }

        System.out.println("ViewContentModel topology checks passed.");
    }
}
