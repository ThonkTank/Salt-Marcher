...
public final class DomainEntityEnforcementDocumentationCheckMain {

    private DomainEntityEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainEntityEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Domain entity enforcement documentation checks passed.");
    }
}
