...
public final class ShellLayerTopologyCheckMain {

    private ShellLayerTopologyCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new ShellLayerTopologyRules().check(context, sink);
        ...
        if (!ordered.isEmpty()) {
            ...
            System.err.println("Shell Layer topology check failed with " + ordered.size()
                    + " violation(s):" + System.lineSeparator() + body);
            System.exit(1);
        }

        System.out.println("Shell Layer topology checks passed.");
    }
}
