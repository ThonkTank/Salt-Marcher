...
public final class DomainLayerDocumentationEnforcementCheckMain {

    private DomainLayerDocumentationEnforcementCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainLayerEnforcementCoverageRules().check(context, sink);
        ...
        System.out.println("Domain layer enforcement documentation checks passed.");
    }
}
