...
public final class DomainLayerTopologyCheckMain {

    private DomainLayerTopologyCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainLayerTopologyRules().check(context, sink);
        ...
        System.out.println("Domain layer topology checks passed.");
    }
}
