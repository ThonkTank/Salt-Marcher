...
public final class DataGatewayEnforcementDocumentationCheckMain {

    private DataGatewayEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataGatewayEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Data gateway enforcement documentation checks passed.");
    }
}
