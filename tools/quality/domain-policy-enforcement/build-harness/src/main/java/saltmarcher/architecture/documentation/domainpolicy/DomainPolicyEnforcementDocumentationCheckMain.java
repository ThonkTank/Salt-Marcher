...
public final class DomainPolicyEnforcementDocumentationCheckMain {

    private DomainPolicyEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainPolicyEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Domain policy enforcement documentation checks passed.");
    }
}
