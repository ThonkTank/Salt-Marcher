...
@BugPattern(
        ...
        summary = "Visual style values must come from centralized stylesheets, including direct-rendered views.",
...
public final class ViewProgrammaticStylingChecker extends BugChecker
    ...
    public Description matchCompilationUnit(CompilationUnitTree tree, VisitorState state) {
        ...
        if (!isTrackedSourcePackage(packageName)) {
        ...
        return buildDescription(tree)
                .setMessage("Package '" + packageName
                        + "' defines visual style values outside centralized resources/salt-marcher.css. Violations: "
