...
public final class PassiveViewTypeShapeBoundaryCheckerTest {

    private final CompilationTestHelper compilationHelper = CompilationTestHelper.newInstance(
            PassiveViewTypeShapeBoundaryChecker.class,
            getClass());
    ...
    public void rejectsProjectViewInheritance() {
        compilationHelper
                .addSourceLines(
                        ...
                        "// BUG: Diagnostic contains: violates the passive-View type shape",
    ...
    @Test
    public void rejectsStaticUtilityShape() {
        compilationHelper
                .addSourceLines(
                        "src/view/slotcontent/primitives/foo/FooView.java",
                        "package src.view.slotcontent.primitives.foo;",
