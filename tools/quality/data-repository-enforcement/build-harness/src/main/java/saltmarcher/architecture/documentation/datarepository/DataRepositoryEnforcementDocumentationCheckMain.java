...
public final class DataRepositoryEnforcementDocumentationCheckMain {

    private DataRepositoryEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataRepositoryEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Data repository enforcement documentation checks passed.");
    }
}
