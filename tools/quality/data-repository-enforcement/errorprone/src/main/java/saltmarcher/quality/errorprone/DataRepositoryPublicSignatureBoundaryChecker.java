...
@BugPattern(
        name = "DataRepositoryPublicSignatureBoundary",
        summary = "Repository adapter signatures must not leak source-local model or source-adapter types.",
        severity = BugPattern.SeverityLevel.ERROR)
public final class DataRepositoryPublicSignatureBoundaryChecker extends BugChecker implements BugChecker.ClassTreeMatcher {
    ...
    public Description matchClass(ClassTree tree, VisitorState state) {
        ...
        return buildDescription(tree)
                .setMessage("Public repository adapter type '" + tree.getSimpleName()
