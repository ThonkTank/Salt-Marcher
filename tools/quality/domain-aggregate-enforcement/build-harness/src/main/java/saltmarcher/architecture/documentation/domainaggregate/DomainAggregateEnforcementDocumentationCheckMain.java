...
public final class DomainAggregateEnforcementDocumentationCheckMain {

    private DomainAggregateEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainAggregateEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Domain aggregate enforcement documentation checks passed.");
    }
}
