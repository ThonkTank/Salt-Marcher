...
public final class ViewContributionModelTopologyCheckMain {

    private ViewContributionModelTopologyCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new ViewContributionModelTopologyRules().check(context, sink);
        ...
        if (!ordered.isEmpty()) {
            ...
            System.err.println("ViewContributionModel topology check failed with " + ordered.size()
                    + " violation(s):" + System.lineSeparator() + body);
            System.exit(1);
        }

        System.out.println("ViewContributionModel topology checks passed.");
    }
}
