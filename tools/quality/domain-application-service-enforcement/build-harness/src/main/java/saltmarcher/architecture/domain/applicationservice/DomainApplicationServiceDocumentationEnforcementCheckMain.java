...
public final class DomainApplicationServiceDocumentationEnforcementCheckMain {

    private DomainApplicationServiceDocumentationEnforcementCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainApplicationServiceDocumentationRules().check(context, sink);
        new DomainApplicationServiceEnforcementCoverageRules().check(context, sink);
        ...
        System.out.println("Domain ApplicationService documentation enforcement checks passed.");
    }
}
