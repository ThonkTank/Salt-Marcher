...
public final class DataQueryTopologyCheckMain {

    private DataQueryTopologyCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataQueryForeignPublishedPayloadSurfaceRules().check(context, sink);
        ...
        System.out.println("Data query topology checks passed.");
    }
}
