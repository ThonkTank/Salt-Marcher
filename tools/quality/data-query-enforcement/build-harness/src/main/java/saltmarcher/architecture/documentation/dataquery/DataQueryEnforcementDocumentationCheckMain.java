...
public final class DataQueryEnforcementDocumentationCheckMain {

    private DataQueryEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataQueryEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Data query enforcement documentation checks passed.");
    }
}
