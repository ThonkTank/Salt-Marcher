...
public final class DataServiceContributionDocumentationEnforcementCheckMain {

    private DataServiceContributionDocumentationEnforcementCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataServiceContributionEnforcementCoverageRules().check(context, sink);
        ...
        System.out.println("Data ServiceContribution documentation enforcement checks passed.");
    }
}
