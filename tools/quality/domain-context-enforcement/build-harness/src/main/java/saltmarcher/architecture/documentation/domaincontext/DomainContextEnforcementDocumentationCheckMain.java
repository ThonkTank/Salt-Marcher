...
public final class DomainContextEnforcementDocumentationCheckMain {

    private DomainContextEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainContextDocumentationRules().check(context, sink);
        new DomainContextEnforcementCoverageRules().check(context, sink);
        ...
        System.out.println("Domain context enforcement documentation checks passed.");
    }
}
