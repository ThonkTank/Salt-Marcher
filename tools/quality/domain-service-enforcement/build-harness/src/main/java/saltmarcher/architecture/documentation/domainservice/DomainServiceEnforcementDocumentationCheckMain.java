...
public final class DomainServiceEnforcementDocumentationCheckMain {

    private DomainServiceEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainServiceEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Domain service enforcement documentation checks passed.");
    }
}
