...
@BugPattern(
        name = "DomainServiceStatelessness",
        summary = "Named-module domain services must be stateless.",
        severity = BugPattern.SeverityLevel.ERROR)
public final class DomainServiceStatelessnessChecker extends BugChecker implements BugChecker.ClassTreeMatcher {
    ...
    public Description matchClass(ClassTree tree, VisitorState state) {
        ...
        return buildDescription(tree)
                .setMessage("Named-module domain service role '" + typeElement.getQualifiedName()
