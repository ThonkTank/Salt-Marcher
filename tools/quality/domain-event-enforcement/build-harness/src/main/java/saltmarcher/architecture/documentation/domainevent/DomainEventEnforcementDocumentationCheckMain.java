...
public final class DomainEventEnforcementDocumentationCheckMain {

    private DomainEventEnforcementDocumentationCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainEventEnforcementDocumentationRules().check(context, sink);
        ...
        System.out.println("Domain event enforcement documentation checks passed.");
    }
}
