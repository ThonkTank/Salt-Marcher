...
public final class DataPersistencecoreDocumentationEnforcementCheckMain {

    private DataPersistencecoreDocumentationEnforcementCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DataPersistencecoreEnforcementCoverageRules().check(context, sink);
        ...
        System.out.println("Data persistencecore enforcement documentation checks passed.");
    }
}
