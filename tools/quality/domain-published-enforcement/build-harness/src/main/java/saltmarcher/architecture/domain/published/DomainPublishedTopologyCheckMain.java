...
public final class DomainPublishedTopologyCheckMain {

    private DomainPublishedTopologyCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainPublishedTopologyRules().check(context, sink);
        ...
        System.out.println("Domain published topology checks passed.");
    }
}
