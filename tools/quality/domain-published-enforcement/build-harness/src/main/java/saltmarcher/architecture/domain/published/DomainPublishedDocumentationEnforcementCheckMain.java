...
public final class DomainPublishedDocumentationEnforcementCheckMain {

    private DomainPublishedDocumentationEnforcementCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new DomainPublishedEnforcementCoverageRules().check(context, sink);
        ...
        System.out.println("Domain published enforcement documentation checks passed.");
    }
}
