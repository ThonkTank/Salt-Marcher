...
public final class LayeringArchitectureDocumentationEnforcementCheckMain {

    private LayeringArchitectureDocumentationEnforcementCheckMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        new LayeringArchitectureEnforcementCoverageRules().check(context, sink);
        ...
        System.out.println("Layering architecture enforcement documentation checks passed.");
    }
}
