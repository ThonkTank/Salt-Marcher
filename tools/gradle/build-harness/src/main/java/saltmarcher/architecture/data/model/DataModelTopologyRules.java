...
public final class DataModelTopologyRules implements ArchitectureRule {
    ...
    public void check(ArchitectureContext context, ViolationSink violations) {
        ...
        validateSchemaContract(context, sourceFiles, violations);
        validateSchemaTableNameOwnership(sourceFiles, violations);
    }

    private void validateSchemaContract(
