    ...
    private static final Map<String, Specification> SPECIFICATIONS = Map.ofEntries(
            ...
            Map.entry("dataServiceContribution", spec(
                    ...
                    rows(
                            row("data-service-contribution-discovery-entrypoint-shape", "Enforced",
                                    ...
                                    List.of("./gradlew pmdDataServiceContributionEnforcement", "./gradlew checkDataServiceContributionEnforcement")),
            ...
            Map.entry("domainApplicationService", spec(
                    ...
                    rows(
                            ...
                            row("domain-applicationservice-no-nested-contracts", "Enforced",
                                    List.of("domain-application-service bundle Error Prone", "DomainApplicationServiceApiShape"),
                                    List.of("./gradlew compileJava", "./gradlew checkDomainApplicationServiceEnforcement")),
                            row("domain-applicationservice-no-direct-infrastructure-construction-source-pattern", "Source-Pattern Enforced",
            ...
            Map.entry("layeringArchitecture", spec(
                    ...
                    rows(
                            ...
                            row("layering-no-domain-service-pass-through-wrapper", "Enforced",
