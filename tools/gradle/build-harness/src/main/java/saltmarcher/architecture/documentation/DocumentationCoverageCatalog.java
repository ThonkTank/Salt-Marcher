    ...
    private static final Map<String, Specification> SPECIFICATIONS = Map.ofEntries(
            ...
            Map.entry("dataMapper", spec(
                    ...
                    rows(
                            ...
                            row("data-mapper-no-source-mechanics", "Review-Owned"),
            ...
            Map.entry("dataModel", spec(
                    ...
                    rows(
                            row("data-feature-schema-contract", "Enforced",
                                    ...
                                    List.of("./gradlew checkDataEnforcement")),
                            row("data-schema-ddl-placement", "Review-Owned"),
            ...
            Map.entry("dataRepository", spec(
                    ...
                    rows(
                            ...
                            row("data-repository-no-public-non-adapter-boundary-types", "Enforced",
                                    List.of("data-repository bundle Error Prone", "DataRepositoryRoleContract"),
                                    List.of("./gradlew compileJava", "./gradlew checkDataEnforcement")),
                            row("data-repository-no-source-mechanics", "Review-Owned"),
                    ...
                    rows(
                            ...
                            row("domain-layer-model-subtree-no-technical-buckets", "Enforced",
                                    List.of(
                                            ...
                                            "DomainLayerTopologyRules"),
                                    List.of("./gradlew checkDomainEnforcement")),
                            row("domain-layer-source-identity-perimeter", "Enforced",
                                    List.of("domain-layer bundle Error Prone", "DomainSourceTopologyPerimeter"),
                                    List.of("./gradlew compileJava", "./gradlew checkDomainEnforcement")),
                            row("domain-layer-public-named-module-type-shape", "Enforced",
                                    List.of("domain-layer bundle Error Prone", "DomainPublicConcreteTypeShape"),
                                    List.of("./gradlew checkDomainEnforcement")),
                            row("domain-layer-public-named-module-field-purity", "Enforced",
                                    List.of("domain-layer bundle Error Prone", "DomainModuleFieldPurity"),
                                    List.of("./gradlew checkDomainEnforcement")),
                            ...
                            row("domain-layer-no-non-applicationservice-public-backend-boundary", "Enforced",
                                    List.of(
                                            "domain-layer bundle ArchUnit",
                                            "publicBackendBoundariesBelowViewMustBeRootDomainApplicationServices"),
                                    List.of("./gradlew checkDomainEnforcement")),
                            ...
                            row("domain-layer-foreign-context-access-only-through-public-boundaries", "Enforced",
                                    List.of("domain-layer bundle ArchUnit", "domainContextsMustOnlyUseForeignContextPublicBoundaries"),
                                    List.of("./gradlew checkDomainEnforcement")),
                            row("domain-layer-foreign-context-explicit-dependencies", "Enforced",
                                    List.of("domain-layer bundle ArchUnit", "domainContextsMustRespectMarkdownAllowedDependencies"),
                                    List.of("./gradlew checkDomainEnforcement")),
                            row("domain-layer-context-dependency-graph-acyclic", "Enforced",
                                    List.of("domain-layer bundle ArchUnit", "domainContextDependencyGraphMustBeAcyclic"),
                                    List.of("./gradlew checkDomainEnforcement")),
            ...
            Map.entry("domainPublished", spec(
                    ...
                    rows(
                            ...
                            row("domain-published-read-model-handle-shape", "Enforced",
                                    ...
                                    List.of("./gradlew compileJava", "./gradlew checkDomainEnforcement")),
                            row("domain-published-readback-seam-exclusive", "Enforced",
                                    List.of("domain-published bundle Error Prone", "DomainPublishedReadbackSeamBoundary"),
                                    List.of("./gradlew compileJava", "./gradlew checkDomainEnforcement")),
            ...
            Map.entry("domainUseCase", spec(
                    ...
                    rows(
                            ...
                            row("domain-usecase-no-root-usecase-chains", "Enforced",
                                    ...
                                    List.of("./gradlew compileJava", "./gradlew checkDomainEnforcement")),
                            row("domain-usecase-no-policy-helper-prefix-source-pattern", "Review-Owned"),
            ...
            Map.entry("layeringArchitecture", spec(
                    ...
                    rows(
                            ...
                            row("layering-no-direct-view-domain-connection-outside-documented-seams", "Enforced Elsewhere",
                                    ...
                                    List.of("see neighboring owner docs and their listed entrypoints")),
                            row("layering-no-non-applicationservice-public-backend-boundary-below-view", "Enforced Elsewhere",
                                    List.of(
                                            "domain-layer-no-non-applicationservice-public-backend-boundary"),
                                    List.of("./gradlew checkDomainEnforcement")),
                            ...
                            row("layering-thin-role-relay-stack-diagnostic", "Enforced",
                                    ...
                                    List.of("./gradlew checkLayeringEnforcement")),
                            row("layering-role-hub-sprawl", "Candidate",
                                    List.of("LayeringRoleHubSprawlCandidate"),
                                    List.of("./gradlew checkLayeringEnforcement", "non-blocking diagnostic group")),
                            row("layering-cross-feature-sprawl", "Candidate",
                                    List.of("LayeringCrossFeatureSprawlCandidate"),
                                    List.of("./gradlew checkLayeringEnforcement", "non-blocking diagnostic group")),
                            row("layering-public-boundary-breadth", "Candidate",
