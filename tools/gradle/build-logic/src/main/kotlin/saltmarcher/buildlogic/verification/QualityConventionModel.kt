...
internal fun Project.createQualityConventionEnvironment(): QualityConventionEnvironment {
    ...
    return QualityConventionEnvironment(
        QualityConventionPackagingMetadata(
            ...
            mainClassNameProvider = providers.gradleProperty("saltMarcherMainClass").orElse("app.SaltMarcherApp"),
            packageVersionProvider = providers.gradleProperty("saltMarcherVersion").orElse("0.1.0"),
            preloaderClassNameProvider = providers.gradleProperty("saltMarcherPreloaderClass").orElse("app.SaltMarcherPreloader"),
            startupWmClassProvider = providers.gradleProperty("saltMarcherStartupWmClass").orElse("app.SaltMarcherApp"),
