// Personality-Presets für NPC-Generierung
// Siehe: docs/services/npcs/NPC-Generation.md
//
// Persönlichkeitseigenschaften werden per ID in Culture.personality referenziert.
// Das zentrale Register definiert alle verfügbaren Optionen.
...
export const personalityAttributeSchema = z.object({
  id: z.string().min(1),
  name: z.string().min(1),
  description: z.string().optional(),
});

export type PersonalityAttribute = z.infer<typeof personalityAttributeSchema>;

// ============================================================================
// PRESET-DATEN
// ============================================================================

export const personalityPresets: PersonalityAttribute[] = [
  // ──────────────────────────────────────────────────────────────────────────
