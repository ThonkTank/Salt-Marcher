...
import { useCharacterCommandPort } from '../../src/renderer/features/party/use-character-command-port.js'

const input = {
  commandId: 'command',
  command: {
    kind: 'delete' as const,
    input: { id: 'character', expectedRevision: 7 }
  }
}
...
function fixture() {
  ...
  const hook = renderHook(() => useCharacterCommandPort('original'), {
    wrapper
  })
  return {
