...
import features.dungeon.adapter.javafx.map.DungeonMapContentModel.InlineLabelEditPresentationKey;
import features.dungeon.adapter.javafx.map.DungeonMapContentModel.InlineLabelEditProjection;
import features.dungeon.adapter.javafx.map.DungeonMapContentModel.InlineLabelEditState;
import features.dungeon.adapter.javafx.map.DungeonMapContentModel.InlineLabelEditorPresentation;
