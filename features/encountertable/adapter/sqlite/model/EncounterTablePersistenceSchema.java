...
public final class EncounterTablePersistenceSchema {
    ...
    public static final SqliteTableSpec ENCOUNTER_TABLE_LOOT_LINKS = table(
            ...
            column("loot_table_id", "INTEGER NOT NULL"));

    public static final String CREATE_ENCOUNTER_TABLES_SQL =
            "CREATE TABLE " + ENCOUNTER_TABLES.name() + " ("
                    + "table_id INTEGER PRIMARY KEY AUTOINCREMENT, "
                    + "name TEXT NOT NULL, "
                    + "description TEXT)";

    public static final String CREATE_ENCOUNTER_TABLE_ENTRIES_SQL =
            "CREATE TABLE " + ENCOUNTER_TABLE_ENTRIES.name() + " ("
    ...
    public static final String CREATE_ENCOUNTER_TABLE_LOOT_LINKS_SQL =
            "CREATE TABLE " + ENCOUNTER_TABLE_LOOT_LINKS.name() + " ("
    ...
    public static final String CREATE_ENCOUNTER_TABLE_ENTRIES_TABLE_INDEX_SQL =
            "CREATE INDEX idx_encounter_table_entries_table ON "
                    + ENCOUNTER_TABLE_ENTRIES.name() + "(table_id)";

    public static final String CREATE_ENCOUNTER_TABLE_ENTRIES_CREATURE_INDEX_SQL =
            "CREATE INDEX idx_encounter_table_entries_creature ON "
                    + ENCOUNTER_TABLE_ENTRIES.name() + "(creature_id)";

    public static final List<String> CREATE_TABLE_SQL = List.of(
            CREATE_ENCOUNTER_TABLES_SQL,
            CREATE_ENCOUNTER_TABLE_ENTRIES_SQL,
            CREATE_ENCOUNTER_TABLE_LOOT_LINKS_SQL);

    public static final List<String> CREATE_INDEX_SQL = List.of(
            CREATE_ENCOUNTER_TABLE_ENTRIES_TABLE_INDEX_SQL,
            CREATE_ENCOUNTER_TABLE_ENTRIES_CREATURE_INDEX_SQL);
