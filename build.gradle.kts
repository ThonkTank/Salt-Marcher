...
import buildlogic.conventions.heuristic.owner.registerCheckOwnerApiBoundaryRoleDispatchTask
...
val checkOwnerApiBoundaryBucketFiles = registerCheckOwnerApiBoundaryBucketFilesTask(ownerConventionSupport)
