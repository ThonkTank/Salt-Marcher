...
final class DungeonEditorStateSaveIntentSupport {

    private DungeonEditorStateSaveIntentSupport() {
    }
    ...
    static @Nullable DungeonEditorSessionCommand toSaveCommand(
        ...
        return DungeonEditorSessionCommands.roomNarrationCommand(new DungeonEditorSessionCommand.RoomNarrationInput(
                card.roomId(),
