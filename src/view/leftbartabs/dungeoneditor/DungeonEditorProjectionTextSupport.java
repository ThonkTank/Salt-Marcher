...
final class DungeonEditorProjectionTextSupport {

    private DungeonEditorProjectionTextSupport() {
    }
    ...
    static List<DungeonEditorRoomNarrationCardProjection> toNarrationCards(
