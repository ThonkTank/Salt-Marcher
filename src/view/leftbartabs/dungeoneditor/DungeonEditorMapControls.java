...
import src.view.leftbartabs.dungeoneditor.DungeonEditorControlsView.MapItem;
...
final class DungeonEditorMapControls {
    ...
    private final ChangeListener<MapItem> selectionListener =
    ...
    void showMaps(List<MapItem> maps, String selectedKey, boolean busy, String statusText) {
    ...
    private void handleSelectionChanged(@Nullable MapItem selectedMap) {
    ...
    private @Nullable MapItem resolveSelected(
            List<MapItem> maps,
            String selectedKey
    ) {
        MapItem selectedMap = maps.stream()
