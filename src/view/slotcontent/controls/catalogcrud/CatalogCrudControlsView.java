...
public final class CatalogCrudControlsView extends VBox {
    ...
    private final Button renameButton = button("Umbenennen", STYLE_COMPACT, STYLE_FLAT);
    private final Button deleteButton = button("Löschen", STYLE_COMPACT, STYLE_FLAT);
    private final Button reloadButton = button("Neu laden", STYLE_COMPACT, STYLE_FLAT);
    ...
    public void bind(CatalogCrudControlsContentModel contentModel) {
        ...
        renameButton.disableProperty().bind(contentModel.renameDisabledProperty());
        deleteButton.disableProperty().bind(contentModel.deleteDisabledProperty());
        reloadButton.visibleProperty().bind(contentModel.reloadVisibleProperty());
        reloadButton.managedProperty().bind(reloadButton.visibleProperty());
        reloadButton.disableProperty().bind(contentModel.reloadDisabledProperty());
        operationBox.visibleProperty().bind(contentModel.operationVisibleProperty());
        operationBox.managedProperty().bind(operationBox.visibleProperty());
    ...
    private void installEditorHandlers(CatalogCrudControlsContentModel contentModel) {
        createButton.setOnAction(event -> publish(createEditorOpenedEvent()));
    ...
    private void installActionHandlers(CatalogCrudControlsContentModel contentModel) {
        reloadButton.setOnAction(event -> publish(reloadRequestedEvent(selectedOrCurrentItemId(contentModel))));
    ...
    private static CatalogCrudControlsViewInputEvent createEditorOpenedEvent() {
        return new CatalogCrudControlsViewInputEvent("", true, "", "", "", "", "", "", false, "");
    }

    private static CatalogCrudControlsViewInputEvent renameEditorOpenedEvent(String itemId) {
        return new CatalogCrudControlsViewInputEvent("", false, "", itemId, "", "", "", "", false, "");
    }
    ...
    private static CatalogCrudControlsViewInputEvent reloadRequestedEvent(String itemId) {
        return new CatalogCrudControlsViewInputEvent("", false, "", "", "", "", "", "", false, itemId);
    }
    ...
    private static CatalogCrudControlsViewInputEvent dismissedEvent() {
        return new CatalogCrudControlsViewInputEvent("", false, "", "", "", "", "", "", true, "");
    }

    private static CatalogCrudControlsViewInputEvent createSubmittedEvent(String draftName) {
        return new CatalogCrudControlsViewInputEvent("", false, draftName, "", "", "", "", "", false, "");
    }

    private static CatalogCrudControlsViewInputEvent renameSubmittedEvent(String itemId, String draftName) {
        return new CatalogCrudControlsViewInputEvent("", false, "", "", itemId, draftName, "", "", false, "");
    }

    private HBox headerRow() {
        HBox row = new HBox(6, titleLabel, spacer(), createButton, renameButton, deleteButton, reloadButton);
