...
final class EncounterStateBinder {
    ...
    private static void bindSessionActions(
        ...
        intentHandler.onPublishedEventRequested(event -> encounters.applyState(StateCommandMapper.toCommand(event)));
    }
    ...
    private static final class StateCommandMapper {
        ...
        private static ApplyEncounterStateCommand toInitiativeCommand(
                EncounterStatePublishedEvent.InitiativeMutation initiative
        ) {
