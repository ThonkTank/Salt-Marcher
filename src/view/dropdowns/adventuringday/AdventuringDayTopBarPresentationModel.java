...
final class AdventuringDayTopBarPresentationModel {
    ...
    private final javafx.beans.property.ReadOnlyObjectWrapper<PanelModel> panel =
            new javafx.beans.property.ReadOnlyObjectWrapper<>(PanelModel.loadingModel());
    private final javafx.beans.property.ReadOnlyObjectWrapper<CalculationModel> calculation =
            new javafx.beans.property.ReadOnlyObjectWrapper<>(CalculationModel.empty(0));

    ReadOnlyStringProperty triggerTextProperty() {
        return triggerText.getReadOnlyProperty();
    }

    javafx.beans.property.ReadOnlyObjectProperty<PanelModel> panelProperty() {
    ...
    CalculationModel beginCalculation(int totalGroupXp) {
        CalculationModel nextCalculation = CalculationModel.empty(totalGroupXp);
        calculation.set(nextCalculation);
