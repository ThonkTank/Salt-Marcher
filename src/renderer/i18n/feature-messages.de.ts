...
export const messagesDe = {
  ...
  'hex.editor.coordinateStatus': 'q {q} · r {r} · {terrain}{location}',
  ...
  'hex.editor.terrainCatalogDeferred': 'Terrain-Katalog folgt',
  ...
  'hex.status.tileTerrain': 'q {q} · r {r} · {terrain}',
  'hex.status.tileTerrainLocation': 'q {q} · r {r} · {terrain} · {location}',
