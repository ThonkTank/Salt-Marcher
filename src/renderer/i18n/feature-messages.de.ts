...
export const messagesDe = {
  ...
  'hex.emptyTile': 'Leeres Hex – Biom malen, um es anzulegen.',
  ...
  'hex.editor.defaultMapName': 'Neue Hex-Karte',
  ...
  'hex.editor.newBiome': 'Neues Biom',
  'hex.editor.catalogSearch': 'Katalog durchsuchen',
  ...
  'hex.editor.biomeCatalogDeferred': 'Biom-Katalog wird geladen',
