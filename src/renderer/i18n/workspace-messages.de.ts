export const workspaceMessagesDe = {
  ...
  'desktop.charactersShortcut': 'Charaktere (Alt+P)',
  'character.unassigned': 'Ohne Szene',
  ...
  'desktop.openCharacters': 'Charaktere öffnen',
  'desktop.editGroups': 'Gruppen bearbeiten',
