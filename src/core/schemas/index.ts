...
export {
  ...
  templateCreatureSlotSchema,
  type TemplateCreatureSlot,
  factionEncounterTemplateSchema,
  type FactionEncounterTemplate,
  factionSchema,
  type Faction,
