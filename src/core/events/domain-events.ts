...
export const EventTypes = {
  ...
  // journal:* Events (6)
  // -------------------------------------------------------------------------
  JOURNAL_CREATE_ENTRY_REQUESTED: 'journal:create-entry-requested',
  JOURNAL_UPDATE_ENTRY_REQUESTED: 'journal:update-entry-requested',
  JOURNAL_DELETE_ENTRY_REQUESTED: 'journal:delete-entry-requested',
...
export interface JournalCreateEntryRequestedPayload {
  /** Entry data without ID (ID is generated by the feature) */
  entry: Omit<JournalEntry, 'id'>;
}

export interface JournalUpdateEntryRequestedPayload {
...
export interface JournalDeleteEntryRequestedPayload {
...
export interface EventPayloadMap {
  ...
  // journal:*
  [EventTypes.JOURNAL_CREATE_ENTRY_REQUESTED]: JournalCreateEntryRequestedPayload;
  [EventTypes.JOURNAL_UPDATE_ENTRY_REQUESTED]: JournalUpdateEntryRequestedPayload;
  [EventTypes.JOURNAL_DELETE_ENTRY_REQUESTED]: JournalDeleteEntryRequestedPayload;
  [EventTypes.JOURNAL_ENTRY_CREATED]: JournalEntryCreatedPayload;
  [EventTypes.JOURNAL_ENTRY_UPDATED]: JournalEntryUpdatedPayload;
  [EventTypes.JOURNAL_ENTRY_DELETED]: JournalEntryDeletedPayload;
