...
import shared.rules.model.ChallengeRating;

/**
 * Shared CR-derived rule lookups reused by importer, creature, and encounter flows.
 *
 * <p>This class owns game-rule derivations from canonical shared Challenge Rating values.
 * Feature-owned compatibility helpers may delegate here, but must not become the source of truth.
 */
@SuppressWarnings("unused")
public final class ChallengeRatingRules {
