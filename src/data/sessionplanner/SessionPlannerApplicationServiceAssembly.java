...
public final class SessionPlannerApplicationServiceAssembly {

    private SessionPlannerApplicationServiceAssembly() {
    }

    public static SessionPlannerApplicationService create(
