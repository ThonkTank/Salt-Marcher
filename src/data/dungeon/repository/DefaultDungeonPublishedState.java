...
final class DefaultDungeonPublishedState {

    private static final String DEFAULT_DUNGEON_NAME = "Dungeon";

    private DefaultDungeonPublishedState() {
    }

    static DungeonAuthoredReadResult authoredRead() {
        return new DungeonAuthoredReadResult.CommittedSnapshot(snapshot());
    }

    static DungeonAuthoredMutationResult authoredMutation() {
    ...
    static DungeonTravelResponse travel() {
