...
/**
 * SQLite-backed local storage for read-only creature catalog access.
 */
public final class SqliteCreatureCatalogLocalDataSource {
    ...
    public SqliteCreatureCatalogLocalDataSource() {
        this(new CreaturesSqliteConnectionFactory(), new CreaturesSchemaMigrator());
    }

    SqliteCreatureCatalogLocalDataSource(
    ...
    public CreatureCatalogRepository.DistinctFilterValues loadFilterValues() {
