...
public final class EncounterServiceContribution implements ServiceContribution {
    ...
    public void register(ServiceRegistry.Builder builder) {
        ...
        builder.registerFactory(
                ...
                services -> {
                    SessionPlannerFactsGateway gateway = new SessionPlannerFactsGateway(
                            services.require(PartyApplicationService.class),
                            services.require(EncounterApplicationService.class));
                    return new SessionPlannerApplicationService(gateway, gateway);
                });
    }

    private static final class SessionPlannerFactsGateway
        ...
        private SessionPlannerFactsGateway(
        ...
        public ActivePartyMembersFact loadActivePartyMembers() {
            ...
            return new ActivePartyMembersFact(
                    true,
                    result.members().stream().map(SessionPlannerFactsGateway::toPartyMemberFact).toList(),
                    "");
        }
        ...
        public EncounterPlanListFact listEncounterPlans() {
            ...
            return new EncounterPlanListFact(
                    true,
                    result.plans().stream().map(SessionPlannerFactsGateway::toSavedEncounterPlanFact).toList(),
                    "");
        }
