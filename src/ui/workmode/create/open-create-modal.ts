// src/ui/workmode/create/open-create-modal.ts
// Public entry point for the declarative workmode create modal.
import type { App } from "obsidian";
import { DeclarativeCreateModal } from "./declarative-modal";
import type {
  CreateSpec,
...
>(
  ...
  return new Promise((resolve) => {
    const modal = new DeclarativeCreateModal(app, spec, options, resolve);
    modal.open();
  });
}
