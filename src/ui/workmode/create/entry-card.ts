// src/ui/workmode/create/entry-card.ts
// Shared helpers to render Library-styled entry cards for the workmode create flows.

import { setIcon } from "obsidian";
import type { EntryRenderContext } from "./entry-manager";
