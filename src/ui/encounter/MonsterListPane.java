...
public class MonsterListPane extends BorderPane {
    ...
    private void loadPage() {
        ...
        Task<CreatureService.PageResult> task = new Task<>() {
            @Override
            protected CreatureService.PageResult call() {
        ...
        task.setOnSucceeded(e -> {
            CreatureService.PageResult result = task.getValue();
        ...
        task.setOnFailed(e -> {
            System.err.println("MonsterListPane.loadPage(): " + task.getException().getMessage());
