...
public final class DungeonEditorProjectionPreviewProjector {

    private DungeonEditorProjectionPreviewProjector() {
    }
    ...
    public static void addEditorPreview(
        ...
        if (preview instanceof DungeonEditorSessionValues.MoveHandlePreview movePreview) {
            ...
            DungeonEditorBoundaryStretchPreviewProjector.addBoundaryStretchPreview(
                    cells,
                    edges,
                    labels,
                    selection,
    ...
    public static void addHandleMovePreview(
        ...
        markers.add(new DungeonEditorMapProjectionSnapshot.MarkerProjection(
                DungeonEditorProjectionElementProjector.handleMarkerLabel(ref.kind()),
                movedCell.q() + 0.5,
                movedCell.r() + 0.5,
                movedCell.level(),
                DungeonEditorProjectionElementProjector.handleMarkerKind(ref.kind()),
                true,
                DungeonEditorPublishedValueProjector.toPublishedHandleRefOrEmpty(movedRef),
                true));
    }
    ...
    private static void addClusterMovePreview(
        ...
        DungeonEditorClusterMovePreviewProjector.addClusterMovePreview(
                cells,
                edges,
                labels,
                areas,
