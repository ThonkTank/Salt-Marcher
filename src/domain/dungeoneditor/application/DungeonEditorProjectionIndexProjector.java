...
public final class DungeonEditorProjectionIndexProjector {

    private DungeonEditorProjectionIndexProjector() {
    }
    ...
    public static String handleKey(DungeonEditorWorkspaceValues.@Nullable HandleRef handleRef) {
        DungeonEditorWorkspaceValues.HandleRef safeRef = handleRef == null
                ? DungeonEditorProjectionPublishedBoundaryTranslator.emptyWorkspaceHandleRef(0L, 0L)
                : handleRef;
