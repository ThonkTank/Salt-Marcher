...
final class SearchCreatureCatalogUseCase {
    ...
    SearchCreatureCatalogUseCase(CreatureCatalogRepository repository) {
    ...
    SearchResult execute(CreatureCatalogQuery query) {
        ...
        return new SearchResult(
                ...
                repository.searchCatalog(normalizedQuery.toSearchSpec()),
                normalizedQuery.pageSize(),
                normalizedQuery.pageOffset()
        );
    }
    ...
    private static NormalizedCatalogQuery normalize(CreatureCatalogQuery query) {
        ...
        return new NormalizedCatalogQuery(
                ...
                effectiveQuery.sortField() == null ? creaturesAPI.CatalogSortField.NAME : effectiveQuery.sortField(),
                effectiveQuery.sortDirection() == null ? creaturesAPI.SortDirection.ASCENDING : effectiveQuery.sortDirection(),
