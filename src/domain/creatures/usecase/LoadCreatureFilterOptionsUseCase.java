...
final class LoadCreatureFilterOptionsUseCase {
    ...
    LoadCreatureFilterOptionsUseCase(CreatureCatalogRepository repository) {
        this.repository = Objects.requireNonNull(repository, "repository");
    }

    CreatureFilterOptions execute() {
        CreatureCatalogRepository.DistinctFilterValues values = repository.loadFilterValues();
