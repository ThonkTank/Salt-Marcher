...
import src.domain.dungeon.map.service.DungeonEditorHandleMovementService;
import src.domain.dungeon.map.service.DungeonRoomTopologyEditor;
import src.domain.dungeon.map.service.DungeonTopologyMovementService;
...
public final class DungeonMap {
    ...
    private static final DungeonEditorHandleMovementService HANDLE_MOVEMENT_SERVICE = new DungeonEditorHandleMovementService();
