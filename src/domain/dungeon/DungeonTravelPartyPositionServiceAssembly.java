...
final class DungeonTravelPartyPositionServiceAssembly {
    ...
    private static final class ApplicationTravelPartyPositionRepository implements TravelPartyPositionRepository {

        private final PartyApplicationService party;
        private final PartyMutationModel partyMutationModel;

        private ApplicationTravelPartyPositionRepository(
