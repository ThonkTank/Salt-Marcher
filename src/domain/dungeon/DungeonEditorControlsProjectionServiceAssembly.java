...
final class DungeonEditorControlsProjectionServiceAssembly {
    ...
    private static List<src.domain.dungeon.published.DungeonMapSummary> publishedMapSummaries(
            List<src.domain.dungeon.model.runtime.editor.session.DungeonEditorWorkspaceValues.MapSummary> maps
    ) {
        List<src.domain.dungeon.published.DungeonMapSummary> result = new ArrayList<>();
        for (src.domain.dungeon.model.runtime.editor.session.DungeonEditorWorkspaceValues.MapSummary map
                : maps == null ? List.<src.domain.dungeon.model.runtime.editor.session.DungeonEditorWorkspaceValues.MapSummary>of() : maps) {
    ...
    private static src.domain.dungeon.published.DungeonMapSummary toPublishedMapSummary(
            src.domain.dungeon.model.runtime.editor.session.DungeonEditorWorkspaceValues.MapSummary map
    ) {
        src.domain.dungeon.model.runtime.editor.session.DungeonEditorWorkspaceValues.MapSummary safeMap = map == null
                ? new src.domain.dungeon.model.runtime.editor.session.DungeonEditorWorkspaceValues.MapSummary(
                        new src.domain.dungeon.model.runtime.editor.session.DungeonEditorWorkspaceValues.MapId(1L),
                        "Dungeon Map",
                        0L)
                : map;
