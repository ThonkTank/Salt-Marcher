...
public final class DungeonDocumentStore {
    ...
    private DungeonDocumentStore() {
    }

    public static DungeonDocumentStore shared() {
    ...
    public synchronized void deleteMap(DungeonMapId mapId) {
        ...
        if (mapId.equals(activeMapId)) {
            activeMapId = documents.isEmpty() ? null : new DungeonMapId(documents.keySet().iterator().next());
        }
    }
    ...
    private static final class Holder {
        private static final DungeonDocumentStore INSTANCE = new DungeonDocumentStore();
    }
}
