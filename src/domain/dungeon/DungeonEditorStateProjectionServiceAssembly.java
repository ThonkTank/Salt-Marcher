...
final class DungeonEditorStateProjectionServiceAssembly {
    ...
    private static List<src.domain.dungeon.published.DungeonEdgeRef> edges(
            List<src.domain.dungeon.model.worldspace.model.workspace.model.DungeonEditorWorkspaceValues.Edge> edges
    ) {
        List<src.domain.dungeon.published.DungeonEdgeRef> result = new ArrayList<>();
        for (src.domain.dungeon.model.worldspace.model.workspace.model.DungeonEditorWorkspaceValues.Edge edge
                : edges == null ? List.<src.domain.dungeon.model.worldspace.model.workspace.model.DungeonEditorWorkspaceValues.Edge>of() : edges) {
