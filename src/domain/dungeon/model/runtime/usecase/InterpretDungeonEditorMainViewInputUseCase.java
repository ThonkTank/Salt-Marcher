...
import src.domain.dungeon.model.runtime.helper.DungeonEditorMainViewInputBoundaryTranslationHelper;
...
public final class InterpretDungeonEditorMainViewInputUseCase {
    ...
    public DungeonEditorMainViewEffect selection(
            ...
            BuildDungeonEditorMainViewInputUseCase.MainViewInput input,
    ...
    private PointerState pointer(BuildDungeonEditorMainViewInputUseCase.MainViewInput input, int projectionLevel) {
