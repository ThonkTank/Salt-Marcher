...
public final class TravelDungeonSessionSurfaceMappingHelper {

    private TravelDungeonSessionSurfaceMappingHelper() {
    }
    ...
    public static SurfaceData toInternalSurface(@Nullable DungeonTravelSurfaceSnapshot surface) {
        ...
        return new SurfaceData(
                ...
                surface.mapName(),
                surface.revision(),
                TravelDungeonSessionMapMappingHelper.toInternalMap(surface.map()),
                ...
                surface.actions().stream().map(TravelDungeonSessionSurfaceMappingHelper::toInternalAction).toList());
    }
