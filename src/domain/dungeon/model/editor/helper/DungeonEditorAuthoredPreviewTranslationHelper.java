...
public final class DungeonEditorAuthoredPreviewTranslationHelper {

    private DungeonEditorAuthoredPreviewTranslationHelper() {
    }

    public static @Nullable DungeonEditorAuthoredOperation toOperation(
    ...
    private static DungeonClusterBoundaryKind boundaryKind(
