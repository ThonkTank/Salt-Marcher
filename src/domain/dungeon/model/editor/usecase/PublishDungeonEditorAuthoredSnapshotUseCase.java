...
public final class PublishDungeonEditorAuthoredSnapshotUseCase {
    ...
    public void execute(LoadDungeonSnapshotUseCase.DungeonSnapshotData snapshot) {
        ...
        DungeonAuthoredPublishedStateRepository.SnapshotPublication publication = snapshotPublication(snapshot);
        if (publication != null) {
            publishedStateRepository.publishSnapshot(publication);
        }
    }
