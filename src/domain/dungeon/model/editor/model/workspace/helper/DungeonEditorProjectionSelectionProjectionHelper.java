...
public final class DungeonEditorProjectionSelectionProjectionHelper {

    private DungeonEditorProjectionSelectionProjectionHelper() {
    }
    ...
    public static boolean selectedArea(
        ...
        return DungeonEditorProjectionPublishedBoundaryTranslationHelper.safeTopologyRef(area.topologyRef()).equals(
                DungeonEditorProjectionPublishedBoundaryTranslationHelper.safeTopologyRef(selection.topologyRef()));
    }
    ...
    public static boolean selectedFeature(
        ...
        return feature != null
                && selection != null
                && DungeonEditorProjectionPublishedBoundaryTranslationHelper.safeTopologyRef(feature.topologyRef()).equals(
                        DungeonEditorProjectionPublishedBoundaryTranslationHelper.safeTopologyRef(selection.topologyRef()));
    }
    ...
    public static boolean selectedBoundary(
        ...
        return boundary != null
                && selection != null
                && DungeonEditorProjectionPublishedBoundaryTranslationHelper.safeTopologyRef(boundary.topologyRef()).equals(
                        DungeonEditorProjectionPublishedBoundaryTranslationHelper.safeTopologyRef(selection.topologyRef()));
    }
    ...
    public static boolean selectedHandle(
        ...
        return ref.kind() == selected.kind()
                && DungeonEditorProjectionPublishedBoundaryTranslationHelper.safeTopologyRef(ref.topologyRef()).equals(
                        DungeonEditorProjectionPublishedBoundaryTranslationHelper.safeTopologyRef(selected.topologyRef()))
