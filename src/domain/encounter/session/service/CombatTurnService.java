...
import src.domain.encounter.session.value.CombatTurnEntry;
import src.domain.encounter.session.value.Combatant;
import src.domain.encounter.session.value.EncounterSessionValues.CombatCardData;
import src.domain.encounter.session.value.EncounterSessionValues.CombatProjectionData;

public final class CombatTurnService {
