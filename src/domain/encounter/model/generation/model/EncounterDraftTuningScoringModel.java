...
final class EncounterDraftTuningScoringModel {
    ...
    private EncounterDraftTuningScoringModel() {
    }

    static int tuningScore(EncounterDraftComposition composition, EncounterTuningIntent tuning, int partySize) {
        EncounterTuningTargets targets = EncounterTuningTargetModel.targetsFor(tuning, partySize);
