...
public record EncounterGenerationDiagnosticsData(
        src.domain.encounter.model.generation.model.EncounterDifficultyIntent resolvedDifficulty,
        src.domain.encounter.model.generation.model.EncounterTuningIntent resolvedTuning,
    ...
    public EncounterGenerationDiagnosticsData {
        ...
        resolvedTuning = resolvedTuning == null
                ? src.domain.encounter.model.generation.model.EncounterTuningIntent.defaultIntent()
                : resolvedTuning;
