...
final class EncounterDifficultyTargets {
    ...
    static EncounterDifficultyBand bandFor(int adjustedXp, EncounterDifficultyMath.Thresholds thresholds) {
    ...
    static int minAdjustedXp(EncounterDifficultyBand band, EncounterDifficultyMath.Thresholds thresholds) {
        return switch (band) {
    ...
    static int maxAdjustedXp(EncounterDifficultyBand band, EncounterDifficultyMath.Thresholds thresholds) {
        return switch (band) {
    ...
    static int targetAdjustedXp(EncounterDifficultyBand band, EncounterDifficultyMath.Thresholds thresholds) {
        return (minAdjustedXp(band, thresholds) + maxAdjustedXp(band, thresholds)) / 2;
    }

    static int candidateMaxXp(EncounterDifficultyMath.Thresholds thresholds) {
