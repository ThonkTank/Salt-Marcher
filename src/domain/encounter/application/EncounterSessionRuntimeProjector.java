...
public final class EncounterSessionRuntimeProjector {
    ...
    public static EncounterSession.BudgetData toSessionBudget(EncounterDifficultyMath.BudgetSummary budget) {
    ...
    public static EncounterSession.GenerationResultData toSessionGenerationResult(
        ...
        return new EncounterSession.GenerationResultData(
                ...
                result.encounters().stream().map(EncounterSessionRuntimeProjector::toSessionGeneratedEncounter).toList(),
                result.message(),
    ...
    public static EncounterSession.GenerationStatus mapSessionStatus(
    ...
    public static EncounterSession.SavedPlanStatus toSessionSavePlanStatus(
    ...
    public static EncounterSession.SavedPlanStatus toSessionLoadPlanStatus(
    ...
    public static EncounterSession.SavedPlanStatus toSessionListPlansStatus(
    ...
    public static EncounterSession.CreatureDetailData toSessionCreatureDetail(CreatureDetail detail) {
    ...
    public static EncounterPlanCreature toPlanCreature(EncounterSession.PlanCreatureData creature) {
        return new EncounterPlanCreature(creature.creatureId(), creature.quantity());
    }

    public static EncounterSession.SavedPlanData toSessionSavedPlan(EncounterPlan plan) {
    ...
    public static EncounterSession.SavedPlanSummaryData toSessionSavedPlanSummary(EncounterPlanSummary summary) {
    ...
    private static EncounterSession.GeneratedEncounterData toSessionGeneratedEncounter(
        ...
        return new EncounterSession.GeneratedEncounterData(
                ...
                encounter.creatures().stream().map(EncounterSessionRuntimeProjector::toSessionGeneratedCreature).toList());
    }
