...
public final class CreatureRepository {
    ...
    public static final String CREATURE_INSERT_SQL = "INSERT INTO creatures("
            ...
            + "senses, passive_perception, languages, legendary_action_count, source_slug, slug_key"
            + ") VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
            ...
            + "legendary_action_count=excluded.legendary_action_count, source_slug=excluded.source_slug, slug_key=excluded.slug_key";
    ...
    private static void bindCreatureParams(PreparedStatement ps, Creature c) throws SQLException {
        ...
        ps.setString(38, c.SourceSlug);
        ps.setString(39, c.SlugKey);
    }
