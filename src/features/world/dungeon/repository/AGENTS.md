...
- `map/cluster/DungeonClusterRepository` — persists top-level cluster rows and cluster-owned structure references.
...
- Route shared physical structure persistence through `map/structure/repository` and the canonical `Structure` snapshot.
