...
- `input/SaveNarrationInput` — room-narration save request — carries the room id, the visual description, and the list of exit narration inputs.
- `input/SaveNarrationExitInput` — room-exit narration request item — carries one authored exit text plus its persisted room-edge coordinates.
