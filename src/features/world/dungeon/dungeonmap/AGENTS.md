...
- Put stable read and lookup behavior on `DungeonMap`; put map-owned cross-owner cluster/corridor preview or validation workflows on `DungeonMapApplicationService`.
