...
- `checkDungeonGeometryConvention` — build-time architecture gate — rejects public/protected dungeon seams that expose raw point/segment collections or reintroduce second geometry dialects.
