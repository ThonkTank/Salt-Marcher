...
This file covers `src/features/world/dungeon/dungoenmap/structure/model/boundary/wall/`.
...
- `Wall` — single-wall owner — uses the internal `BoundaryObject` mechanics and owns wall-local state plus wall-specific split-on-delete behavior and kind semantics.
