...
public enum StairPathPatternKind {
    ...
    public static StairPathPatternKind parse(String value) {
        if (value == null || value.isBlank()) {
            return STACK;
        }
        try {
            return StairPathPatternKind.valueOf(value.trim().toUpperCase(Locale.ROOT));
