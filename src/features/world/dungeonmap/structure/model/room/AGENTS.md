...
`StructureRoomTopology` is the public aggregate seam; projection indexing and graph indexing stay package-local beneath it.
...
- Do not re-home room edit workflows from the room owner into this subtree; this package owns reused structure-backed room truth, not room CRUD workflows.
