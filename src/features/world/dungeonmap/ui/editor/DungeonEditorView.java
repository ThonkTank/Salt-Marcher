...
import features.world.dungeonmap.application.editor.DungeonEditorLoadState;
import features.world.dungeonmap.application.editor.DungeonEditorService;
import features.world.dungeonmap.application.editor.DungeonEditorWorkflow;
...
public final class DungeonEditorView implements AppView {
    ...
    private final DungeonEditorWorkflow workflow;
    ...
    public DungeonEditorView(
        ...
        this.workflow = new DungeonEditorWorkflow(this.mapCatalogService, this.editorService);
        configureStatePane();
