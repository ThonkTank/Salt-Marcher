package features.world.dungeonmap.runtime.presentation.ui;

import features.world.dungeonmap.api.DungeonCorridorSummary;
import features.world.dungeonmap.runtime.loading.application.DungeonRuntimeLoadState;
...
import features.world.dungeonmap.runtime.loading.ui.DungeonControls;
import features.world.dungeonmap.runtime.presentation.ui.workspace.DungeonRuntimeSplitWorkspace;
...
public final class DungeonView implements AppView {
    ...
    private void showLoadState(DungeonRuntimeLoadState loadState) {
        ...
        controls.setActiveRoomName(DungeonInspectorPresenter.activeLocationLabel(layout, loadState.state().activeLocation(), loadState.corridorTopology()));
    }
