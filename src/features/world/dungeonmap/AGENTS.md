...
- Room/cluster persistence keeps the existing `anchor_x2` columns as canonical raw coordinates. Legacy cluster seed rows are cleared on write and ignored on load; boundary/opening/floor rows are the geometry truth.
