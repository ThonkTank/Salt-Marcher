...
- Clusters persist membership ownership plus derived center/level metadata and canonical per-level `StructureObject.LevelStructure` rows for anchors, explicit surface cells, boundary/opening edges, and optional floor cells.
