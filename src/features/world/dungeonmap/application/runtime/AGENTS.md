...
- `DungeonRuntimeActionResolver` owns executable runtime action assembly. It consumes the shared parsed runtime location and the resolved runtime description exits without turning `description/` into a workflow owner.
