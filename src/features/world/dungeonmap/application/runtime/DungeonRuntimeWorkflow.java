...
public final class DungeonRuntimeWorkflow {
    ...
    public DungeonRuntimeWorkflow(DungeonMapCatalogService mapCatalogService, DungeonRuntimeService runtimeService) {
    ...
    private DungeonRuntimeLoadState prepareLoad(features.world.dungeonmap.domain.model.DungeonRuntimeState state) throws Exception {
