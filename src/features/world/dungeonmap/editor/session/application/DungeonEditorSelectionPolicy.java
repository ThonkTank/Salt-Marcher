...
public final class DungeonEditorSelectionPolicy {
    ...
    public DungeonSelection selectCorridorTargetSelection(
            DungeonEditorSessionState state,
            DungeonLayout layout,
            features.world.dungeonmap.corridors.model.DungeonCorridorEndpoint target
    ) {
        if (layout == null) {
            return null;
        }
        if (target instanceof features.world.dungeonmap.corridors.model.DungeonCorridorEndpoint.Room roomEndpoint) {
        ...
        if (target instanceof features.world.dungeonmap.corridors.model.DungeonCorridorEndpoint.Corridor corridorEndpoint) {
    ...
    public static DungeonSelection focusedTarget(DungeonLayout layout, DungeonLayoutEditResult result) {
        return DungeonEditorSelectionSupport.focusedTarget(layout, result);
    }
