...
export class TimelineView extends ItemView {
    ...
    async onOpen(): Promise<void> {
        ...
        logger.info("[timeline-view] View opened");
    }
    ...
    async onClose(): Promise<void> {
        ...
        logger.info("[timeline-view] View closed");
    }
    ...
    private renderTimeline(): void {
        ...
        logger.info("[timeline-view] Rendered timeline", {
    ...
    private handleClearTimeline(): void {
        ...
        this.store.clear();
        logger.info("[timeline-view] Timeline cleared by user");
    }
}
