...
export class InboxStatusBar {
    ...
    private subscribeToInbox(): void {
        ...
        logger.info("[inbox-status-bar] Subscribed to inbox updates");
    }
    ...
    private updateDisplay(count: number): void {
        ...
        logger.info("[inbox-status-bar] Display updated", { count });
    }
    ...
    private openInboxMenu(event: MouseEvent): void {
        ...
        logger.info("[inbox-status-bar] Menu opened", { itemCount: inbox.length });
    }
    ...
    private handleInboxItemClick(item: InboxItem): void {
        ...
        logger.info("[inbox-status-bar] Item clicked and marked as read", {
    ...
    private handleMarkAllAsRead(): void {
        ...
        logger.info("[inbox-status-bar] All inbox items marked as read");
    }
    ...
    private async handleOpenTimeline(): Promise<void> {
        try {
            ...
            logger.info("[inbox-status-bar] Timeline view opened");
        } catch (error) {
            logger.error("[inbox-status-bar] Failed to open Timeline view", error);
        }
    }
    ...
    destroy(): void {
        ...
        logger.info("[inbox-status-bar] Destroyed");
    }
}
