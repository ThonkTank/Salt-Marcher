...
public class StatBlockPane extends VBox {
     ...
     * See AGENTS.md "Delimited string formats" for the storage convention.
     */
     ...
     * See AGENTS.md "Delimited string formats" for the storage convention used across all stat columns.
     */
