package features.creaturecatalog.model;
...
public class Creature {
    ...
    public enum RelationLoadState {
        BASE,
        PARTIAL,
        FULL
    }

    /** Tracks which related collections have been hydrated from the DB. */
    public RelationLoadState relationLoadState = RelationLoadState.BASE;
}
