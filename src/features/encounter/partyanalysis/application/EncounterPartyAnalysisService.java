package features.encounter.partyanalysis.application;

import database.DatabaseManager;
import features.creatures.model.Creature;
import features.encounter.partyanalysis.model.CreatureCapabilityTag;
import features.encounter.partyanalysis.model.CreatureRoleProfile;
import features.encounter.partyanalysis.model.EncounterWeightClass;
import features.encounter.partyanalysis.repository.EncounterPartyAnalysisRepository;
import features.encounter.partyanalysis.repository.EncounterPartyAnalysisRepository.CreatureBaseRow;
import features.encounter.partyanalysis.repository.EncounterPartyAnalysisRepository.CreatureDynamicRow;
import features.encounter.partyanalysis.repository.EncounterPartyAnalysisRepository.CreatureStaticRow;
import features.encounter.partyanalysis.repository.EncounterPartyCacheRepository;
import features.encounter.partyanalysis.repository.EncounterPartyCacheRepository.CacheState;
import features.encounter.partyanalysis.repository.EncounterPartyCacheRepository.CacheStatus;
import features.encounter.partyanalysis.service.CreatureFunctionRoleClassifier.Classification;
import features.encounter.partyanalysis.service.CreatureFunctionRoleClassifier;
import features.encounter.partyanalysis.service.CreatureStaticAnalysisService;
import features.encounter.partyanalysis.service.EncounterWeightClassClassifier;
...
public final class EncounterPartyAnalysisService {
    ...
    public static CreatureRoleProfile classifyRoleProfileForActiveParty(Creature creature) {
        if (creature == null) {
            return new CreatureRoleProfile(null, EncounterWeightClass.REGULAR, null, null, Set.of(),
