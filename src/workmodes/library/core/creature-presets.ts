...
export async function loadCreaturePreset(app: App, file: TFile): Promise<StatblockData> {
    ...
    // Note: Spellcasting migration removed. Entries are now simplified to basic fields only.
    // Complex features (components, spellcasting) should be added via separate edit workflow.
