// src/workmodes/atlas/view/regions.ts
...
import {
    ...
    REGIONS_FILE,
    type Region,
} from "../../../features/maps/data/region-repository";
import { loadTerrains, watchTerrains } from "../../../features/maps/data/terrain-repository";
import {
    openCreateModal,
    type CreateSpec,
    type DataSchema,
