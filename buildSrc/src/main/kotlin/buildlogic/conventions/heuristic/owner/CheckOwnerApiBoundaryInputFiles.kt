...
internal fun analyzeInputFile(
    ...
    if (sourceFile.context.packageName == "importer.pipeline.input") {
    ...
    if (sourceFile.context.packageName == "features.loottable.input") {
        return OwnerConventionAnalysis(reasons = emptyList(), model = null)
    }
    ...
    if (sourceFile.context.packageName == "features.world.dungeon.catalog.input") {
        return OwnerConventionAnalysis(reasons = emptyList(), model = null)
    }
    if (sourceFile.context.packageName == "features.world.dungeon.dungeonmap.input") {
        return OwnerConventionAnalysis(reasons = emptyList(), model = null)
    }
    if (sourceFile.context.packageName == "features.world.dungeon.shell.editor.statepane.input") {
        return OwnerConventionAnalysis(reasons = emptyList(), model = null)
    }
    ...
    if (sourceFile.context.packageName == "features.world.hexmap.editorsurface.input") {
        return OwnerConventionAnalysis(reasons = emptyList(), model = null)
    }
    ...
    if (sourceFile.context.packageName == "features.world.dungeon.dungeonmap.structure.input") {
        return OwnerConventionAnalysis(reasons = emptyList(), model = null)
    }
