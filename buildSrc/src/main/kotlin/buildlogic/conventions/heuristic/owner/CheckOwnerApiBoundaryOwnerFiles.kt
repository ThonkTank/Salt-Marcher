...
internal fun analyzeOwnerFile(
    ...
    if (sourceFile.context.packageName == "database" ||
        ...
        sourceFile.context.packageName == "features.encountertable.recovery" ||
        ...
        sourceFile.context.packageName == "features.world.hexmap.travelsurface" ||
        ...
        sourceFile.context.packageName == "features.world.dungeon.dungeonmap.model" ||
        sourceFile.context.packageName == "features.world.dungeon.dungeonmap.structure" ||
