// tests/workmodes/atlas/terrain-create-modal.test.ts
...
import { TerrainsRenderer } from "../../../src/workmodes/atlas/view/terrains";
import * as createModule from "../../../src/features/data-manager/edit";
