...
import { measureElements, measureElementsGrouped } from '../ui-measurement/measurement-api';
import { validateUI, formatReport, type ValidationRule } from '../ui-measurement/validation-engine';
import { waitForAnimation } from '../ui-measurement/dom-utils';

/**
 * Take screenshot of modal
 */
export const screenshotModal: CommandHandler = async (app: App, args: string[]) => {
  logger.log('[IPC-CMD] Taking screenshot of modal...');
  ...
  try {
    ...
    logger.log('[IPC-CMD] Screenshot saved to:', screenshotPath);
    ...
    logger.error('[IPC-CMD] Screenshot failed:', error);
