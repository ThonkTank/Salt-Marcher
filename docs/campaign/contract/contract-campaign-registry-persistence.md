...
Source of Truth: Installation-owned Campaign registry stored truth, schema,
validation, and current-format initialization.
...
Until that activation, the Campaign registry has one disposable current format:
