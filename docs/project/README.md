...
This directory owns cross-feature canonical SaltMarcher documentation.
Project-wide documentation placement and layer rules are owned by the
...
- [Owner Interviews](interviews/README.md)
...
- [Document Size Policy Roadmap](docs/project/architecture/doc-size-policy-vision-and-roadmap.md:1)
...
- [Autonomy Boundaries](docs/project/architecture/autonomy-boundaries.md:1)
...
- [SaltMarcher Target Operating Model Plan](docs/project/architecture/saltmarcher-target-operating-model-plan.md:1)
...
- [ADR Template](docs/project/decisions/0000-template.md:1)
- [Honest Instruments Base Gates ADR](docs/project/decisions/0003-honest-instruments-base-gates.md:1)
- [Content-Addressed Harness Verification ADR](docs/project/decisions/0004-content-addressed-harness-verification.md:1)
...
- [Architecture Migration Owner Status Notes M3](docs/project/architecture/architecture-migration-owner-status-notes-m3-2026-07-09.md:1)
...
- [Architecture Migration Worldplanner Target Design](docs/project/architecture/architecture-migration-worldplanner-target-design.md:1)
- [Architecture Migration Creatures Baseline](docs/project/architecture/architecture-migration-creatures-baseline.md:1)
- [Architecture Migration Creatures Target Design](docs/project/architecture/architecture-migration-creatures-target-design.md:1)
- [Architecture Migration Party Baseline](docs/project/architecture/architecture-migration-party-baseline.md:1)
- [Architecture Migration Party Target Design](docs/project/architecture/architecture-migration-party-target-design.md:1)
- [Architecture Migration Session Planner Baseline](docs/project/architecture/architecture-migration-sessionplanner-baseline.md:1)
- [Architecture Migration Session Planner Target Design](docs/project/architecture/architecture-migration-sessionplanner-target-design.md:1)
- [Architecture Migration Session Planner LOC Exception](docs/project/architecture/architecture-migration-sessionplanner-loc-exception.md:1)
- [Architecture Migration Encounter Table Baseline](docs/project/architecture/architecture-migration-encountertable-baseline.md:1)
- [Architecture Migration Encounter Table Target Design](docs/project/architecture/architecture-migration-encountertable-target-design.md:1)
...
- [Anchored Popup Requirements](docs/project/requirements/requirements-anchored-popup.md:1)
- [Dialog Surface Requirements](docs/project/requirements/requirements-dialog-surface.md:1)
- [Dropdown Popup Requirements](docs/project/requirements/requirements-dropdown-popup.md:1)
- [Progress Meter Requirements](docs/project/requirements/requirements-progress-meter.md:1)
- [Travel State Tab Requirements](docs/project/requirements/requirements-travel-state-tab.md:1)
- [Resource Policy](docs/project/policies/resource-policy.md:1)
...
- [Quality Platforms Local Entry Points](docs/project/verification/quality-platforms-local-entrypoints.md:1)
