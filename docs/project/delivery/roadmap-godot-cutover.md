...
- native saved Encounter proof covers Campaign-partition validation, ordered
  ...
  and save-current through one ordinary plan commit. A real 1366 x 768 OpenGL
  render keeps the expanded tuning docket, brass alternative navigator,
  diagnostics, and roster controls legible in one vertically scrolling stage.
  Grouped Encounter-table/World sources, masks, passive display, and final
  cockpit composition remain unfinished;
