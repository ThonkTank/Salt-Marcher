...
- native World Planner provider proof covers independently identified
  ...
  paginated search, NPC statblock/faction/place selection, and place-faction
  removal/relink without endpoint deletion. Its narrative proof additionally
  ...
  visible Inspector create/close/trash/restore journey. Encounter and Encounter
  Tables remain explicit unavailable sections;
