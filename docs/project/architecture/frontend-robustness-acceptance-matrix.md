...
| Travel | read projection, write, view state | query authority, original-campaign journaled commands and persistent route draft owner verified; save/discard/restart and closed-window travel pass; pre-action editor transitions remain open | FR6 | provider/Scene isolation, joint Session result, local-intent reconciliation |
