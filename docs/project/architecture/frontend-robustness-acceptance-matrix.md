...
| Travel | read projection, write, view state | query authority plus original-campaign journaled command owner verified; persistent route draft integration remains open | FR6 | provider/Scene isolation, joint Session result, local-intent reconciliation |
