...
- `src/view/statetabs/<entry>/`: one global state tab contribution
...
Encounter is a state tab, so it must not participate in startup navigation
selection.
...
- view-layer contribution, Binder, PresentationModel, IntentHandler, View, and
...
- [ADR 011: Passive Workbench Shell Architecture Model](/home/aaron/Schreibtisch/projects/SaltMarcher/docs/project/architecture/adr-011-shell-workbench-architecture-model.md:1)
