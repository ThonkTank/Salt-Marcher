...
| M13 | Resolve all drafts                            | Shared save/discard/cancel owners, partial-failure tests and ten SceneDesktop E2E cases including scene location/focus; Hex plan/receipt backend and productive command owner verified; independent saved-plan revisions reach the renderer; Travel Electron regression passes; eleven previous Electron cases pass; persistent route drafts and pre-action editor transitions remain open                                                                     | 4: multi-editor save/discard/cancel, partial save failure, edit barrier                             |
