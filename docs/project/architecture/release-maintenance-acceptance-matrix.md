...
| M13 | Resolve all drafts                            | Shared save/discard/cancel owners, partial-failure tests and ten SceneDesktop E2E cases including scene location/focus; Hex plan/receipt backend passes ten native cases; travel renderer ownership and UI acceptance still open                                                                     | 4: multi-editor save/discard/cancel, partial save failure, edit barrier                             |
