...
| M21 | Explicit baseline selection                   | Explicit request resolver; source/download/CLI tests; live document-only release rejection                                                              | 6: resolver implemented; actual CI fixture production and full target qualifier/workflow integration pending            |
