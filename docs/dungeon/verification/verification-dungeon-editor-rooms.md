...
| `DE-ROOM-001` | Paint isolated room | Room family plus primary drag/release | `F0_EMPTY_MAP` | One room and cluster persist, authored cells match the rectangle, and derived perimeter renders. | Ready |
