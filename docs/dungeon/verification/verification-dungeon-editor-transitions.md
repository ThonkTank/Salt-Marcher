...
| --- | --- | --- | --- | --- | --- |
| `DE-TRN-001` | Create transition | Transition family, destination state card, primary map click | `F6_MULTI_LEVEL_FLOORS` | Transition row, destination, topology, snapshot, and marker persist and reload. | Ready |
