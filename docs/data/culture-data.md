...
> **Konsumiert von:** [NPC-Resolution](../features/encounter/NPC-Resolution.md) (Name/Personality-Generierung)
...
| activities | FactionActivityRef[] | Aktivitaets-Referenzen | Optional, → [Flavour.md](../features/encounter/Flavour.md) |
...
- Hierarchische Vererbung ueber Faction-Kette (Merge-Regeln in [NPC-Resolution.md](../features/encounter/NPC-Resolution.md))
