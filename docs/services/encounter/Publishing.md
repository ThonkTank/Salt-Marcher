...
> **Verantwortlichkeit:** Step 7 der 7-Step-Pipeline - Instance-Erstellung und Event-Publishing
> **Input:** `BalancedEncounter` aus [Adjustments](Adjustments.md)
> **Output:** `EncounterInstance`, `encounter:generated` Event (sticky)
>
> **Referenzierte Schemas:**
> - [npc.md](../../data/npc.md) - NPC-Referenzen fuer Shop-Integration
> - [faction.md](../../data/faction.md) - Attrition-Tracking
>
> **Verwandte Dokumente:**
> - [Encounter.md](Encounter.md) - Pipeline-Uebersicht
> - [Combat-System.md](../Combat-System.md) - Combat-Integration
> - [Initiation.md](Initiation.md) - Trigger-Events
...
→ Loot-Generierung Details: [Flavour.md](Flavour.md#step-4-loot-generierung), [Loot.md](../Loot.md)
...
→ Shop-Schema: [Shop.md](../../data/shop.md)
