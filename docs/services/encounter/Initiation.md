...
> **Verantwortlichkeit:** Step 1 der 7-Step-Pipeline - Trigger empfangen, Context aufbauen
> **Input:** `encounter:generate-requested` Event
> **Output:** `EncounterContext` an [Population](Population.md)
>
> **Referenzierte Schemas:**
> - [terrain-definition.md](../../data/terrain-definition.md) - Terrain mit Features
> - [faction.md](../../data/faction.md) - Fraktionspraesenz
>
> **Verwandte Dokumente:**
> - [Encounter.md](Encounter.md) - Pipeline-Uebersicht
> - [Publishing.md](Publishing.md) - Output-Events
> - [Travel-System.md](../Travel-System.md) - Travel-Trigger
...
- [terrain-definition.md](../../data/terrain-definition.md) - Terrain-Definition mit Feature-Pools
