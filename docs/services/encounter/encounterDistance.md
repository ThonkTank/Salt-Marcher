...
**Hinweis:** Initial-Positioning fuer Combat-Simulation wird durch `initialDistance` bestimmt. Optimale Reichweiten werden dynamisch pro Matchup in [actionScoring.md](../combatantAI/actionScoring.md#optimale-reichweite-dynamisch) berechnet.
