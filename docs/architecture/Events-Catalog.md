...
|--:|:------:|--------|-------|--------------|:----:|:----:|------|------|------|
| 950 | ⬜ | Time | features | rest:* Events im Events-Catalog definieren | hoch | Ja | - | Events-Catalog.md#rest, EventBus.md, Time-System.md, Character-System.md, encounter/Encounter.md | docs/architecture/Events-Catalog.md (bereits dokumentiert) |
| 951 | ⛔ | Time | features | rest:* Event-Typen in Core definieren | hoch | Ja | #950 | Events-Catalog.md#rest, Core.md, EventBus.md | src/core/events/types.ts [ändern] |
