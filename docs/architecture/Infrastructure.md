...
| 2928 | ⬜ | Infrastructure | - | Preset Index: Re-Exports aller bundled Presets (creatures, terrains, items) | hoch | Ja | #1703 | Infrastructure.md#build-prozess, EntityRegistry.md#entity-type-mapping | [neu] presets/index.ts:bundledPresets export |
