...
| 2338 | ⬜ | Application/SessionRunner | - | Party-Manage-Button (Öffnet Party-Tab im DetailView) | mittel | Nein | #2307, #3216 | SessionRunner.md#party-sektion, Character-System.md | src/application/session-runner/view.ts:onManageParty() - öffnet DetailView mit Party-Tab via workspace.getLeaf() + setViewState({activeTab: 'party'}). Abhängig von #3216 (Party-Tab Component) |
