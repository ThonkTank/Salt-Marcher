...
- Monster rolling, initiative editing, Combat turn progression, HP and
  condition changes, bounded undo, direct Combat end, result configuration,
...
- mob cards expose individual front-member HP and conditions from the same
  persistent Scene group members
