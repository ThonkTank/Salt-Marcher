...
| 3113 | ⛔ | Item | features | Standard D&D Item Presets erweitern: Waffen (Longsword, Dagger, Greataxe), Rüstungen (Chainmail, Leather), Gear (Rope, Torch, Rations), Consumables (Healing Potion) mit vollständigen Properties und Tags | hoch | Nein | #1600, #3112 | Item.md#kategorie-details, presets/items/ | - |
| 3132 | ⛔ | Item | features | Library Item CRUD UI: Item erstellen/bearbeiten/löschen mit Category-spezifischen Feldern (Weapon Properties, Armor AC, etc.) | hoch | Nein | #1609, #2599 | Item.md, Application.md#library | - |
| 3133 | ⬜ | Item | features | Item Storage Port Interface: loadAllItems(), saveItem(), deleteItem() mit Vault JSON Adapter | hoch | Nein | #1600 | Item.md, Infrastructure.md#storage-ports | - |
| 3156 | ⬜ | Item | features | Equipment Actions: equipItem(characterId, itemId), unequipItem(characterId, itemId) mit equipped-Flag Toggle und Slot-Validierung (nur 1 armor, 1 shield, etc.) | mittel | Nein | #1603, #600 | Item.md#equipment-system, Inventory-System.md | - |
| 3157 | ⬜ | Item | features | calculateArmorClass(character): AC-Berechnung basierend auf equipped armor + shield + DEX-Modifier | mittel | Nein | #1603 | Item.md#equipment-system, Combat-System.md#armor-class | - |
| 3158 | ⬜ | Item | features | getEquippedWeapons(character): Query für equipped Waffen mit damage und properties für Combat-Integration | mittel | Nein | #1603, #1607 | Item.md#equipment-system, Combat-System.md#attack-rolls | - |
