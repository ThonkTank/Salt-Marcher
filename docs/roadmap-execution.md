...
Vor Ausführung des dritten Gastlaufs präzisierter Wiederholungsaudit anhand
bestehender Quellen: `scanHandoff` in `scripts/local-storage/compatibility.ts`
klassifiziert jeden neuen Aufrufnachweis als eigenes Artefakt. Dadurch ändert
sich beim zweiten Aufruf legitim das Inventar der letzten Phase
`storage-retention-applied`; deren Nachweis darf neu erhoben werden. Die acht
vorherigen Programm-/Daten-/Runtime-Phasen müssen dagegen vollständig und mit
identischen Nachweisen wiederverwendet werden. Kein neues Backup, keine erneute
Aktivierung oder Laufzeitprüfung. Audit verlangt identische erste acht
Phasendatensätze zwischen beiden Originalreceipts und erlaubt ausschließlich
für die letzte Inventarprüfung erneute Ausführung. Beide Aufrufe und deren
Herkunft müssen erhalten sein. Dies ist eine vor dem Lauf anhand des bestehenden
Inventarvertrags präzisierte Abnahme, keine Lockerung des fehlgeschlagenen
ed19-Backup-Audits. Kein Produkt-/Harnesswechsel und keine Entfernung unbekannter
Inventareinträge, um Wiederverwendung zu erzwingen.

### Phase 5: erfolgreicher Wiederholungsaudit, lineare Main-Historie

187002ca823643a0338ddf4121e634a279952f8d: vollständiger Check34695982824
success. Echter kanonischer Handoff im Gast und Wiederholung bestanden;
Archiv `canonical-handoff-v3-run-3` (12 Dateien) vollständig unabhängig
geprüft: VM0/Test0, unterschiedliche Host-/Gast-Boot-ID, unveränderte
Originalreceipts und Herkunft beider Aufrufe, komplette Hashkette aller neun
Phasen. Erste acht Phasen byteinhaltlich identisch wiederverwendet; ausschließlich
Inventar um zweiten Aufruf ergänzt. Artefakt-SHA-256:
77d1f486449cb0a0f0bdfc7cfeb1f90926e295c91049bdf05f62481dbd6151a7.
Finalreceipt-SHA-256: ce0fc87a3d536a824b8dd3d9ea708032f68d860358e8a9b3a004b24ab7433c31.
Privater RAM-Seed entfernt; kein Host-AppImage ausgeführt. Originale Nachweise
bytegleich in den passenden separaten Hostcheckout übernommen.

Die kanonische Promotion wurde serverseitig mit GH013 abgewiesen: Main verlangt
lineare Historie; der bereits vorhandene Integrationsmerge4a87219b2 ist enthalten.
Main blieb e4fc7fd4e. Der erste lokale Start des Promotionsbefehls scheiterte
zuvor rein an einem nicht normalisierten systemd-Arbeitspfad; normalisierter
Pfad und tatsächlich ignoriertes Dependencyverzeichnis behoben dies. Keine
Produkt- oder Sicherheitsregeländerung. Erfolgreicher Handoff bleibt belegt,
Main-Gate und Phase5-Abschluss bleiben offen.

Fixplan Historie: neuer isolierter Candidate direkt auf unverändertem Main,
finalen Dateistand187002ca8 als einen linearen Commit übernehmen und den
identischen Anwendungsteil über Git-Tree-/Diff-Prüfung bestätigen. Bestehenden
Candidate und Nachweise erhalten, weder Main-Regel umgehen noch fremde Historie
umschreiben. Aktuellen Ausführungslog ergänzen. Neuer Candidate-PR, vollständige
exakte CI und echter zweifacher Handoff für die neue Commitidentität; kein
Übertragen alter Receipts auf einen anderen SHA. Danach kanonische Promotion
und grünes Main. Phase6 soll lineare-Historie-Verstöße frühzeitig bei Candidate-
Prüfung erkennen, damit diese vorhandene Serverregel nicht erst nach dem Handoff
auffällt. Inhaltliche App-/SQL-/UI-Arbeit wird dafür nicht erneut verändert.

Linearer Candidate vorbereitet: vollständiger Git-Tree vor ergänztem Log exakt
