...
Source of Truth: Compatibility redirect to canonical documentation at `docs/maps/architecture/architecture-maps-dungeon-adoption.md`.

# Architecture Maps Dungeon Adoption Stub
