...
**Verantwortlichkeit:** Step 5 der 7-Step-Pipeline
- Step 5.0: Setup (Grid, Positionen, Resource Budget)
- Step 5.1: Runden-Simulation (PMF-basierte Berechnung)
- Step 5.2: Outcome-Analyse (Siegwahrscheinlichkeit, TPK-Risk)
- Step 5.3: Klassifizierung (Win% + TPK -> Difficulty)
...
Erstellt Combat-Profile fuer alle Party-Mitglieder basierend auf dem Action-Schema aus [Creature.md](../../domain/Creature.md#action-schema).
...
- **Sweet-Spot/Pain-Point:** [Flavour.md#schritt-2-sweet-spot-berechnen](Flavour.md#schritt-2-sweet-spot-berechnen)
