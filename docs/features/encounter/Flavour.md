...
| 3277 | ⬜ | Encounter | prototyp | NPC-Instanziierung mit Detail-Stufen + Highlight-NPCs + Wiederverwendung. Deliverables: (1) Detail-Stufen: Lead (name, 2 traits, quirk, goal), Highlight (name, 1 trait), Anonym (creature-typ + count), (2) Lead-NPC: 1 pro Gruppe, persistiert (in-memory für Prototyp), (3) Highlight-NPCs: Max 3 global, nur aus Gruppen mit >1 Kreatur, (4) NPC-Wiederverwendung: Existierende NPCs bevorzugen, bei Mehrfach-Match geografisch nächsten wählen (lastKnownPosition), (5) GeneratedNpc-Schema: detailLevel, traits[], quirk, goal | mittel | Nein | #3264 | features/encounter/Flavour.md, domain/NPC-System.md | prototype/pipeline/npc-generator.ts: generateLeadNPC(), generateHighlightNPCs(), findExistingNPC(), prototype/types/encounter.ts: GeneratedNpc mit detailLevel/traits/quirk |
