...
**Verantwortlichkeit:** Step 6 der 7-Step-Pipeline
- Step 6.0: Ziel-Difficulty wuerfeln (Terrain-Threat)
- Step 6.1: Anpassungs-Algorithmus (beste Option waehlen)
- Anpassbare Parameter (Distance, Disposition, Environment, Activity, Multi-Group, Creature-Slots)
- Save-Logik mit Gruppen-Generierungs-Loop
...
| **Environment** | Terrain-Features aktivieren | `terrain.features[]` | [Terrain.md](../../domain/Terrain.md#schema) |
