...
|--:|:------:|--------|-------|--------------|:----:|:----:|------|------|------|
| 900 | ✅ | Time | core | TimeState Interface (currentTime, activeCalendarId) | hoch | Ja | - | Time-System.md#schemas, EntityRegistry.md | src/core/schemas/time.ts, src/features/time/types.ts, src/features/time/time-store.ts |
| 901 | ✅ | Time | core | GameDateTime Interface (year, month, day, hour, minute, computed fields) | hoch | Ja | #900 | Time-System.md#gamedatetime | src/core/schemas/time.ts |
| 903 | ✅ | Time | core | CalendarDefinition Schema (months, weekdays, seasons, timeSegments) | hoch | Ja | - | Time-System.md#calendardefinition, EntityRegistry.md | src/core/schemas/time.ts |
| 905 | ✅ | Time | core | CalendarSeason Interface (name, months) | hoch | Ja | #903 | Time-System.md#calendardefinition | src/core/schemas/time.ts |
| 906 | ✅ | Time | core | TimeSegment Type ('dawn', 'morning', 'midday', 'afternoon', 'dusk', 'night') | hoch | Ja | - | Time-System.md#gamedatetime, Time-System.md#time-segment-berechnung | src/core/schemas/time.ts, src/core/schemas/common.ts |
| 908 | ✅ | Time | features | time:set-requested Handler | hoch | Ja | #900, #901 | Time-System.md#set-zeit-setzen, Events-Catalog.md#time | src/features/time/time-service.ts (setupEventHandlers L213-239) |
| 910 | ✅ | Time | features | time:segment-changed Event publizieren | hoch | Ja | #909 | Time-System.md#events, Events-Catalog.md#time | src/features/time/time-service.ts (publishSegmentChanged), src/core/events/domain-events.ts |
| 912 | ✅ | Time | features | getTimeSegment() Funktion mit Wrap-Around-Logik | hoch | Ja | #906 | Time-System.md#time-segment-berechnung | src/features/time/time-utils.ts (getTimeSegment, isInRange) |
| 914 | ⬜ | Time | features | time:set-calendar-requested Handler | niedrig | Nein | #903 | Time-System.md#kalender-wechseln, Events-Catalog.md#time | src/features/time/time-service.ts:setupEventHandlers() [ändern], src/features/time/time-service.ts:setCalendar() [neu] |
| 916 | ⛔ | Time | features | time:calendar-change-failed Event publizieren | niedrig | Nein | #914 | Time-System.md#events, Events-Catalog.md#time | src/features/time/time-service.ts:publishCalendarChangeFailed() [neu], src/core/events/domain-events.ts |
| 918 | ⛔ | Time | features | Visibility-Modifier pro TimeSegment (dawn 50%, night 10%, etc.) | mittel | Nein | #906, #843, #848 | Time-System.md#sichtweiten-einfluss, Map-Feature.md#visibility-system | src/features/map/visibility-utils.ts:getTimeModifier() [neu], src/features/map/visibility.ts:calculateVisibility() [ändern] |
| 952 | ⛔ | Time | core | RestState Interface (status, type, hoursCompleted, hoursRemaining, interruptionCount) | hoch | Ja | #951 | Time-System.md#resting | src/core/schemas/time.ts [ändern] |
| 954 | ⛔ | Time | features | Rest-Service (Stunden-Loop mit Encounter-Checks) | hoch | Ja | #953, #215 | Time-System.md#resting, Time-System.md#encounter-unterbrechung, Encounter-System.md, Events-Catalog.md#rest | src/features/time/rest-service.ts [neu] |
| 902 | ✅ | Time | core | Duration Interface (years, months, days, hours, minutes) | hoch | Ja | - | Time-System.md#zeit-operationen | src/core/schemas/time.ts |
| 904 | ✅ | Time | core | CalendarMonth Interface (name, days, season) | hoch | Ja | #903 | Time-System.md#calendardefinition | src/core/schemas/time.ts |
| 907 | ✅ | Time | features | time:advance-requested Handler | hoch | Ja | #900, #902 | Time-System.md#advance-zeit-voranschreiten, Events-Catalog.md#time | src/features/time/time-service.ts (setupEventHandlers L164-210) |
| 909 | ✅ | Time | features | time:state-changed Event publizieren | hoch | Ja | #907, #908 | Time-System.md#events, Events-Catalog.md#time | src/features/time/time-service.ts (publishStateChanged), src/core/events/domain-events.ts |
| 911 | ✅ | Time | features | time:day-changed Event publizieren | hoch | Ja | #909 | Time-System.md#events, Events-Catalog.md#time | src/features/time/time-service.ts (publishDayChanged), src/core/events/domain-events.ts |
| 913 | ✅ | Time | features | addDuration() Funktion für Zeit-Arithmetik | hoch | Ja | #901, #902 | Time-System.md#advance-zeit-voranschreiten | src/features/time/time-utils.ts (addDuration, normalizeTime) |
| 915 | ⛔ | Time | features | time:calendar-changed Event publizieren | niedrig | Nein | #914 | Time-System.md#events, Events-Catalog.md#time | src/features/time/time-service.ts:publishCalendarChanged() [neu], src/core/events/domain-events.ts |
| 917 | ⬜ | Time | features | convertTime() zwischen Kalendern | niedrig | Nein | #903 | Time-System.md#kalender-wechseln | src/features/time/time-utils.ts:convertTime() [neu] |
| 919 | ⛔ | Time | features | Darkvision negiert Night-Modifier | mittel | Nein | #918, #849 | Time-System.md#darkvision, Map-Feature.md#visibility-system, Character-System.md#sinne | src/features/map/visibility-utils.ts:getTimeModifier() [ändern], src/features/party/types.ts:CharacterSenses [neu] |
| 953 | ⛔ | Time | features | Rest-Store (State Machine: idle → resting → paused) | hoch | Ja | #952 | Time-System.md#resting, Time-System.md#state-machine | src/features/time/rest-store.ts [neu] |
...
| 2964 | ⬜ | Time | features | getCurrentSeason(): Aktuelle Saison aus GameDateTime + CalendarDefinition ableiten | hoch | Ja | #905 | Time-System.md#calendardefinition | - |
| 2965 | ⬜ | Time | core | CalendarDefinition erweitern: Mondphasen-System und Celestial Events (Himmelszyklen) | hoch | Ja | #903 | Time-System.md#calendardefinition | - |
| 3134 | ⬜ | Time | core | RestSettings Interface (grittyRealism: boolean) für Normal vs Gritty Realism Modus | hoch | --deps | #952 | Time-System.md#gritty-realism-option | - |
| 3135 | ⬜ | Time | features | getRestDuration(): Berechnet Rast-Dauer basierend auf type (short/long) und grittyRealism-Option | hoch | --spec | #3134 | Time-System.md#gritty-realism-option | - |
| 3136 | ⬜ | Time | features | rest:pause-requested Event Handler (Rast pausieren bei Encounter-Unterbrechung) | hoch | --deps | #953 | Time-System.md#encounter-unterbrechung, Events-Catalog.md#rest | - |
| 3138 | ⬜ | Time | features | rest:resume-requested Event Handler (Rast fortsetzen nach Unterbrechung) | hoch | --deps | #953 | Time-System.md#encounter-unterbrechung, Events-Catalog.md#rest | - |
| 3139 | ⬜ | Time | features | rest:restart-requested Event Handler (Rast neu starten nach Unterbrechung, hoursCompleted=0) | hoch | --deps | #953 | Time-System.md#encounter-unterbrechung, Events-Catalog.md#rest | - |
| 3140 | ⬜ | Time | features | rest:short-rest-requested Event Handler (Short Rest initialisieren) | hoch | --deps | #953 | Time-System.md#resting, Events-Catalog.md#rest | - |
| 3141 | ⬜ | Time | features | rest:long-rest-requested Event Handler (Long Rest initialisieren) | hoch | --deps | #953 | Time-System.md#resting, Events-Catalog.md#rest | - |
| 3142 | ⬜ | Time | features | rest:short-rest-completed Event publizieren (bei erfolgreichem Short Rest Abschluss) | hoch | --deps | #953 | Time-System.md#rest-abschluss, Events-Catalog.md#rest | - |
| 3143 | ⬜ | Time | features | rest:long-rest-completed Event publizieren (bei erfolgreichem Long Rest Abschluss) | hoch | --deps | #953 | Time-System.md#rest-abschluss, Events-Catalog.md#rest | - |
| 3144 | ⬜ | Time | features | rest:paused Event publizieren (bei Encounter-Unterbrechung während Rast) | hoch | --deps | #953 | Time-System.md#encounter-unterbrechung, Events-Catalog.md#rest | - |
| 3146 | ⬜ | WorldEvents | core | WorldEvent Schema (id, title, description, scheduledTime, repeat, tags) | hoch | --spec | - | Time-System.md#worldevent-zukunft, EntityRegistry.md | - |
| 3147 | ⬜ | WorldEvents | core | RepeatRule Interface für wiederkehrende WorldEvents (Mondzyklen, jährliche Feste) | mittel | --spec | #3146 | Time-System.md#worldevent-zukunft | - |
| 3149 | ⬜ | WorldEvents | core | JournalEntry erweitern: type-Feld für feinere Kategorisierung (arrival, combat, encounter, rest, quest_progress, death, worldevent, note) | hoch | --spec | #2200,#2201 | Time-System.md#journalentry-vergangenheit | - |
| 3150 | ⬜ | WorldEvents | features | WorldEvent Lifecycle: Automatisches Erstellen von JournalEntry wenn scheduledTime erreicht | hoch | --spec | #3146,#2200 | Time-System.md#worldevent-lifecycle | - |
| 3151 | ⬜ | WorldEvents | features | WorldEvents Feature: time:state-changed Subscriber prüft fällige Events | hoch | --deps | #909,#3146 | Time-System.md#time-worldevents-beziehung | - |
| 3152 | ⬜ | WorldEvents | features | worldevents:due Event publizieren (wenn WorldEvent scheduledTime erreicht hat) | hoch | --spec | #3151 | Time-System.md#time-worldevents-beziehung, Events-Catalog.md | - |
| 3153 | ⬜ | WorldEvents | features | worldevents:upcoming Event publizieren (kommende Events für Timeline-Anzeige) | mittel | --spec | #3151 | Time-System.md#time-worldevents-beziehung, Events-Catalog.md | - |
| 3160 | ⬜ | Time | features | Time Feature Orchestrator Initialisierung: Lade aktiven Kalender aus EntityRegistry | hoch | --spec | #900,#903 | Time-System.md, Conventions.md#factory-functions | - |
| 3161 | ⬜ | WorldEvents | features | WorldEvents Feature Orchestrator: createWorldEventsOrchestrator() Factory | hoch | --deps | - | Time-System.md#time-worldevents-beziehung, Conventions.md#factory-functions | - |
| 3162 | ⬜ | Time | infrastructure | Rest Feature Storage Port: RestState persistent speichern/laden (Resumable-Category) | hoch | --deps | - | Time-System.md#resting, Conventions.md#storage-ports | - |
