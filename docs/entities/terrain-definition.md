...
|---------|-------------------|----------------|
| road | Rastplatz, Wegschrein | Strassenpflaster, Meilenstein |
| plains | Huegel, Steinkreis | Hohes Gras, Wildblumen |
| forest | Lichtung, Alte Ruine, Hoehle | Dichtes Gebuesch, Umgestuerzte Baeume, Kraeuterpflanzen |
| hills | Aussichtspunkt, Versteckte Hoehle | Felsbrocken, Gestruepp |
| mountains | Berghoehle, Alter Wachturm | Felsvorspruenge, Gelocker Gestein, Bergkraeuter |
...
| water | Insel, Gestrandetes Wrack | Untiefen, Felsen, Seetang |
