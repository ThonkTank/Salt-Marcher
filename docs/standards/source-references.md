...
`/home/aaron/Schreibtisch/projects/references/` is not a staging area for product import corpora,
...
- prefer an HTML original under `/home/aaron/Schreibtisch/projects/references/.tools/html/<slug>.html`
- use `/home/aaron/Schreibtisch/projects/references/.tools/markdown/<slug>.md` only when the publisher
  provides source Markdown or the original is already Markdown
- keep PDFs or other binary originals in the most specific
  `/home/aaron/Schreibtisch/projects/references/<topic>/` folder when HTML is not the useful original form
...
Local repository sources do not need to be mirrored into `/home/aaron/Schreibtisch/projects/references/`.
...
generated catalog inputs into `/home/aaron/Schreibtisch/projects/references/`. They are local sources, not
reference mirrors.
...
- cite the readable extracted source path under `/home/aaron/Schreibtisch/projects/references/`
...
- cite local repo evidence with the concrete repo path instead of a
  `/home/aaron/Schreibtisch/projects/references/` mirror
...
- source originals saved outside `/home/aaron/Schreibtisch/projects/references/.tools/` without a clear
  format reason
