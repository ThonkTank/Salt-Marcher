...
purity, domain-wide forbidden infrastructure dependency references, public
domain published-carrier shape, domain role-shape checks, service-registry
registration placement, data-root service export shape,
