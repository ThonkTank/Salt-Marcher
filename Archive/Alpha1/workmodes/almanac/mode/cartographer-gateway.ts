...
import { getEventAnchorTimestamp, type CalendarEvent, type CalendarTimestamp, type PhenomenonOccurrence } from "../helpers";
import type { HookDispatchGateway, HookDispatchContext } from "../data/calendar-state-gateway";
import { registerCartographerHookGateway } from "@services/orchestration";
...
registerCartographerHookGateway(cartographerHookGateway);
