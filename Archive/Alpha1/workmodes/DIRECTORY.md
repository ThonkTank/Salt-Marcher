...
3. Travel-Trigger delegieren über `session-runner/travel/infra/encounter-sync` an die Encounter-App und aktualisieren Routen über `session-runner/travel/engine`.
