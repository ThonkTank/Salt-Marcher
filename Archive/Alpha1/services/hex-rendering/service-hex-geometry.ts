// src/services/hex-rendering/hex-geometry.ts
// Hex rendering geometry utilities - edge, corner, and shape calculations
//
// This module provides low-level geometric operations for rendering hex-based maps:
// - Corner coordinate system (identifying specific vertices of hexes)
// - Edge calculations (midpoints, directions between hexes)
// - Pathfinding between corners (A* algorithm)
// - Distance calculations (point-to-line-segment)
...
// ============================================================================
// Section 2: Edge Utilities (from hex-edges.ts)
// ============================================================================
...
// ============================================================================
// Section 3: Corner Utilities (from hex-corners.ts)
// ============================================================================
...
export function findPathBetweenCorners(
    ...
    while (openSet.size > 0 && iterations < maxDepth) {
        ...
        // Check all neighbors
        const neighbors = adjacentCorners(current);
