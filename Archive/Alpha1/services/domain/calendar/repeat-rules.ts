/**
 * Repeat Rule Types and Calculations
 *
 * Repeat rule definitions and calculation logic.
 * These types are shared across all workmodes and features.
 *
 * @module services/domain/calendar/repeat-rules
 */
...
import { getTotalDaysInYear, clampDayToMonth, mod } from './calendar-schema';
