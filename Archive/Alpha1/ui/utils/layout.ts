...
export function getCenterLeaf(app: App): WorkspaceLeaf {
    ...
    app.workspace.getLeaf(true);
    logger.debug("Center leaf resolved:", leaf);
    return leaf;
}
