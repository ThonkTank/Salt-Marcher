...
import features.dungeon.domain.core.structure.corridor.CorridorAnchorSnap;
import features.dungeon.domain.core.structure.corridor.CorridorBindings;
import features.dungeon.domain.core.structure.corridor.CorridorEndpointBinding;
...
final class DungeonStructureInvariantScenarios {
    ...
    private DungeonStructureInvariantScenarios() {
    }
    ...
    private static features.dungeon.domain.core.structure.DungeonMap transitionMap(
            Transition... transitions
    ) {
        return new features.dungeon.domain.core.structure.DungeonMap(
                new features.dungeon.domain.core.structure.DungeonMapMetadata(
                        new features.dungeon.domain.core.structure.DungeonMapIdentity(4L),
                        "transition proof map"),
                features.dungeon.domain.core.structure.topology.SpatialTopology.empty(),
                features.dungeon.domain.core.structure.room.RoomCatalog.empty(),
                List.of(),
