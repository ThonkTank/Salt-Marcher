...
import static src.view.leftbartabs.dungeoneditor.DungeonEditorTestSupport.*;

final class DungeonEditorRoomWallDoorScenarios {


    private DungeonEditorRoomWallDoorScenarios() {
    }
    ...
    static void runClusterMovement() throws Exception {
        route(() -> verifySelectedStraightWallStretchThroughMapView());
        route(() -> verifyWallRunDragMovesEmbeddedDoorThroughMapView());
        route(() -> verifySelectedStraightWallInwardStretchThroughMapView());
        route(() -> verifySelectedWallCornerMoveThroughMapView());
        route(() -> verifySelectedWallCornerInwardMoveThroughMapView());
        route(() -> verifyInvalidCornerShrinkRejectedThroughMapView());
        route(() -> verifyWholeClusterMoveThroughMapView());
        route(() -> verifyUiCreatedRoomCornerMoveAfterReloadThroughMapView());
    }

    static void runDoor() throws Exception {
        route(() -> verifyDoorCreateThroughMapView());
        route(() -> verifyDoorDeleteThroughMapView());
    }

    static void runRoom() throws Exception {
        route(() -> verifyRoomNarrationThroughStateView());
        route(() -> verifyRoomPreviewThroughMapView());
        route(() -> verifyIsolatedRoomPaintThroughMapView());
        route(() -> verifyOverlappingRoomPaintThroughMapView());
        route(() -> verifyPartitionedRoomPaintPreservesIdentityThroughMapView());
        route(() -> verifyAdjacentRoomPaintThroughMapView());
        route(() -> verifyRoomDeleteThroughMapView());
        route(() -> verifyCancelDraftThroughMapView());
    }

    static void runWall() throws Exception {
        route(() -> verifyWallStartDraftThroughMapView());
        route(() -> verifyWallHoverAlignedOffGridInputThroughMapView());
        route(() -> verifyWallPreviewMoveThroughMapView());
        route(() -> verifyWallPathSecondaryCompletionThroughMapView());
        route(() -> verifyWallIntermediateAndExistingWallCompletionThroughMapView());
        route(() -> verifyWallSingleClickModeThroughControls());
        route(() -> verifyWallDeleteSegmentRunThroughMapView());
        route(() -> verifyWallDeleteCornerRunsThroughMapView());
        route(() -> verifyExteriorWallDeleteRejectedThroughMapView());
    }
    ...
    private static void verifyRoomNarrationThroughStateView() {
    ...
    private static void verifySelectedStraightWallStretchThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifySelectedStraightWallInwardStretchThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWallRunDragMovesEmbeddedDoorThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifySelectedWallCornerMoveThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifySelectedWallCornerInwardMoveThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyInvalidCornerShrinkRejectedThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWholeClusterMoveThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyUiCreatedRoomCornerMoveAfterReloadThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyDoorCreateThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyDoorDeleteThroughMapView() {
        verifyUnboundDoorDeleteThroughMapView();
        verifyCorridorBoundDoorDeleteRejectionThroughMapView();
    }


    private static void verifyUnboundDoorDeleteThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyCorridorBoundDoorDeleteRejectionThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyRoomPreviewThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyIsolatedRoomPaintThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyOverlappingRoomPaintThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyPartitionedRoomPaintPreservesIdentityThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyAdjacentRoomPaintThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyRoomDeleteThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWallStartDraftThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWallHoverAlignedOffGridInputThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWallPreviewMoveThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWallPathSecondaryCompletionThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWallIntermediateAndExistingWallCompletionThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWallSingleClickModeThroughControls() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWallDeleteSegmentRunThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyWallDeleteCornerRunsThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyExteriorWallDeleteRejectedThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyCancelDraftThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
