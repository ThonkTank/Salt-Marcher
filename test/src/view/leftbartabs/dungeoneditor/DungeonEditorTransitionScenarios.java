...
final class DungeonEditorTransitionScenarios {


    private DungeonEditorTransitionScenarios() {
    }

    static void run() throws Exception {
        route(() -> verifyTransitionCreateThroughMapView());
        route(() -> verifyEdgeTransitionCreateThroughMapView());
        route(() -> verifyTransitionAnchorRoundtripThroughPersistence());
        route(() -> verifyMalformedTransitionAnchorsRejectReload());
        route(() -> verifyTransitionDescriptionThroughStateView());
        route(() -> verifyBidirectionalTransitionLinkThroughStateView());
        route(() -> verifyTransitionDeleteThroughMapView());
    }
    ...
    private static void verifyTransitionDescriptionThroughStateView() {
    ...
    private static void verifyBidirectionalTransitionLinkThroughStateView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyTransitionCreateThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyEdgeTransitionCreateThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyTransitionAnchorRoundtripThroughPersistence() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
    ...
    private static void verifyMalformedTransitionAnchorsRejectReload() {
    ...
    private static void verifyTransitionDeleteThroughMapView() {
        TestRuntime runtime = TestRuntime.create();
        TestBinding binding = bindTest(runtime);
        DungeonEditorControlsView controls = binding.controls();
        DungeonMapView mapView = binding.mapView();
