...
public final class DungeonEditorRuntimeDraftOwnerProbe {
    ...
    public static void assertWallDraftPathOwner() {
        ...
        assertTrue(completed.effect().applyPreview() instanceof DungeonEditorSessionValues.ClusterBoundariesPreview,
                "wall draft owner applies only on explicit completion");
        DungeonEditorSessionValues.ClusterBoundariesPreview applied =
                (DungeonEditorSessionValues.ClusterBoundariesPreview) completed.effect().applyPreview();
        ...
        assertTrue(cancelled.effect().applyPreview() == null,
    ...
    private static PointerState corridorDoorPress() {
        ...
        HandleTarget handle = new HandleTarget(
                ...
                11L,
                0,
                new src.domain.dungeon.model.runtime.editor.interaction.DungeonEditorInteractionValues.CellTarget(4, 2, 0),
                "EAST");
        return new PointerState(
                4,
                2,
    ...
    private static void assertNoApply(DungeonEditorMainViewEffect effect, String message) {
        assertTrue(effect.applyPreview() == null, message);
    }
