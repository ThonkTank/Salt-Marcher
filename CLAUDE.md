...
docs/                  # Authoritative documentation (German)
  ...
  research/
    combat-director-concept/
      combat-director-concept.md  # Konzept-Phase, abhängig von Performance-Fixes
    expectimax.md  # Analyse von Expectimax als AI-Architektur für den Combat ...
    gobt.md  # Research & Evaluation
    htn.md  # Konzept-Analyse
    influence-maps.md  # ⚠️ HISTORISCH - Implementierung abweichend
