...
src/                   # Source code
  ...
  services/
    combatSimulator/
      ...
      actionScoring.ts  # Ziel: DPR-basierte Bewertungslogik fuer Combat-Aktionen
      baseValuesCache.ts  # Ziel: Combat-Level Caching-Infrastruktur fuer Base-Values...
      cellPositioning.ts  # Ziel: Cell-basiertes Positioning-System fuer Combat-AI
...
docs/                  # Authoritative documentation (German)
  ...
  services/
    combatSimulator/
      ...
      turnExploration.md  # Turn-Planungslogik fuer Combat-AI - wie sequenzieren wir ...
    encounter/
